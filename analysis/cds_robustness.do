********************************************************************************
* CDS-SHOCK ROBUSTNESS
* Input : Data\cds_induced_position.csv  (built by build\build_cds_panel.ipynb)
* Produces: Table XI (amplification under credit shocks)  +  Appendix Table A7 (orthogonality)
********************************************************************************

clear all

* 1. Import the data
import delimited "C:\\Users\\hermesf\\Projects\\JobMarket\\Data\\cds_induced_position.csv", clear
...
* --- TABLE XI: binary (cols 1-2), intensity (col 3), constraining (col 3) & relaxing (col 4) regimes ---
...
* --- APPENDIX TABLE A7: orthogonality of HF positioning to the credit shock ---
import delimited "C:\Users\hermesf\Projects\JobMarket\Data\cds_induced_position.csv", clear
