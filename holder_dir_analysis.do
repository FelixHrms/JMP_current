...
capture log close
log using "/Users/felixhermes/Library/CloudStorage/OneDrive-Personal/PhD/JobMarket/Code/holder_dir_analysis.log", replace text
...
preserve
    ...
    graph export "/Users/felixhermes/Library/CloudStorage/OneDrive-Personal/PhD/JobMarket/Figures/holder_dir_timeseries.png", replace width(2000)
restore
...
graph export "/Users/felixhermes/Library/CloudStorage/OneDrive-Personal/PhD/JobMarket/Figures/IR_holder_dir_hedged.png", replace width(2000)
...
twoway (rarea ci_up_hf ci_lo_hf horizon if grp==1, color(red%20) lwidth(none)) ///
    ...
    legend(order(3 "HF bonds" 4 "Matched non-HF bonds") rows(1) position(6) region(lstyle(none))) ///
    graphregion(color(white))
graph export "/Users/felixhermes/Library/CloudStorage/OneDrive-Personal/PhD/JobMarket/Figures/IR_holder_dir_directional.png", replace width(2000)
