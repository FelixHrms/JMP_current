...
\noindent This paper presents evidence that the leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks, leading to temporary overshooting. Combining granular regulatory data on repo positions with high-frequency monetary policy surprises, I study how hedge fund trading shapes the sensitivity of individual bond yields. A sequence of progressively tighter specifications traces this amplification to leveraged positioning itself rather than to bond characteristics or the behavior of the dealers that intermediate the trades. Four results emerge. Among comparable bonds, those traded by hedge funds are more volatile only on shock days, because their positioning raises the sensitivity of yields to the surprise. This additional sensitivity accounts for more than a quarter of the total yield movement these surprises generate and scales with position intensity. The amplification operates symmetrically, with comparable strength whether a shock moves prices in favor of a position or against it, consistent with leveraged investors rebalancing toward their desired exposure. Finally, its strength depends on the structure of the hedge fund book, and not only on the size of the position, as it is concentrated among bonds held within directional books and essentially absent when the book offsets its long and short positions.
