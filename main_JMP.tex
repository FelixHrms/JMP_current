...
Table \ref{tab:side_book} splits the constraint-regime regressions of Table \ref{tab:asymmetry} by the side of the hedge fund position and by the directionality of the books holding the bond. Each column re-estimates the intensity specification on the bond-days in one cell. Net long and net short positions are classified by the sign of the hedge fund net position, the constraining and relaxing regimes are defined as in Table \ref{tab:asymmetry}, and the two panels split hedge fund bonds at the median of holder directionality as in Table \ref{tab:directionality}. All non-shock days and all bond-days without hedge fund activity remain in every column as the within-bond baseline. Panel A shows that within directional books the amplification is present in all four cells. On the constraining side it is the same for long and short positions, at 0.185 and 0.172, as a margin constraint that binds mechanically implies. On the relaxing side it is 0.124 for long positions and 0.379 for short positions on tightening surprises, the configuration in which the coordinated net-short book of the hiking cycle meets a surprise that confirms its direction. Panel B shows that within hedged books the amplification lies between 0.03 and 0.06 in every cell. The absence of amplification within hedged books therefore holds regardless of the side of the position and of whether the shock moves against it or in its favor. The larger average amplification of short positions in the full sample reflects that long positions are held disproportionately within hedged books, and not a difference in the response of the two sides. \\
\begin{table}[h!]
\centering
...
\end{tabular}
\label{tab:side_book}
\caption*{\textit{Notes:} This table re-estimates the intensity specification of Table \ref{tab:asymmetry} separately by the side of the hedge fund position, by constraint regime, and by the directionality of the books holding the bond. \textit{Net long} and \textit{Net short} refer to the sign of the hedge fund net position in the bond. The constraining regime contains the bond-days on which the position is on the losing side of the shock, meaning net long on tightening days and net short on easing days, and the relaxing regime those on which it is on the winning side. Panel A restricts the hedge fund bond-days on shock days to bonds whose holder directionality lies above the median among hedge fund bonds, and Panel B to bonds below the median, as in Table \ref{tab:directionality}. Every column also includes all non-shock days and all bond-days without hedge fund activity, which serve as the within-bond baseline. \textit{Log HF Intensity} is the natural log of one plus the average absolute hedge fund net position over the prior five trading days, scaled by the bond's total amount outstanding. \textit{Shock} is the 2-year OIS rate change during the ECB monetary event window. The Shock main effect is absorbed by the fixed effects. Standard errors are clustered by business date and bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}
\clearpage
