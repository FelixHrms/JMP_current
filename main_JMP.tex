...
\indent I am grateful to Michael Bauer, Ayelen Banegas, Lennart Dekker, Daniel Dieckelmann, Stefan Greppmair, Maurizio Habib, Vasso Ioannidou, Christoph Kaufmann, Ioanna Neamtu, Loriana Pelizzon, Maik Schmeling, Fabricius Somogyi, Valeri Sokolovski, Davide Tomio, Charles O'Donnell and participants of the EFA Doctoral Tutorial, ECB Seminar Series, IFABS 2026, the 2026 Aarhus Finance Forum, and members of the MPC Taskforce on Banking Analysis for Monetary Policy for helpful comments and suggestions. This paper received the best PhD Paper Award at the IFABS 2026 Conference. 
\indent \textbf{Disclaimer: } This paper should not be reported as representing the views of the European Central Bank (ECB). The views expressed are those of the author and do not necessarily reflect those of the ECB.}
\vspace{3cm}
...
\noindent This paper shows that the leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks, leading to temporary overshooting. Combining granular regulatory data on repo positions with high-frequency monetary policy surprises, I study this amplification at the individual bond level. Four results emerge. First, even among comparable bonds, hedge funds add excess volatility on shock days, because their positioning raises the sensitivity of yields to the surprise. Second, this additional sensitivity accounts for more than a quarter of the total yield movement these surprises generate and scales with position intensity. Third, the amplification is two-sided and operates whether a shock moves prices in favor of a position or against it, consistent with leveraged investors rebalancing toward their desired exposure. Finally, it is concentrated among bonds held in directional books and essentially absent when the book offsets its long and short positions.
...
Hedge funds have become increasingly important players in global financial markets, and how this growing footprint affects the sensitivity of asset prices to shocks can be viewed from two perspectives. By correcting mispricings and providing liquidity, hedge funds could push prices toward fundamental value and dampen the reaction to shocks. Their reliance on leverage, however, magnifies the effect of price changes on their capital. If they adjust their positions in response, their trading could push prices away from fundamental value and amplify the reaction to shocks. Whether hedge funds increase or decrease price sensitivity in a given situation is ultimately an empirical question. 

This question has become even more important as financial intermediation has shifted away from traditional banks since the global financial crisis. Hedge funds have attracted particular attention as they were at the center of stress episodes such as the March 2020 dash-for-cash in the US Treasury market \citep{barth2025, kruttli2025, aramonte2023}. They leverage their positions through short-term repurchase agreements, yet granular data on these transactions has been largely unavailable. Moreover, the existing evidence is concentrated in stress episodes and focused on market functioning rather than the cross-sectional pricing of bonds. This leaves open whether leveraged trading by hedge funds shapes price formation outside of crises, and what kind of positioning drives the effect when it does.

This paper addresses this gap using granular regulatory data on euro area repo transactions. I show that the leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks. For bonds traded by hedge funds, more than a quarter of the yield reaction reflects positioning rather than the fundamental news itself. This overshooting is temporary, and its strength depends not only on the size of the position but also on the directionality of the hedge fund book that holds it.

Identifying this effect requires both detailed position data and a clean source of exogenous price variation. The repo market data provide a transaction-level view of the euro area repo market and allow me to track the daily positioning of hedge funds across individual sovereign bonds. For the second requirement, I combine this micro data with bond market data and high-frequency monetary policy surprises, which serve as a laboratory for exogenous price variation. These surprises are considered exogenous shocks because they are measured in tight windows around monetary policy announcements and therefore capture only the unanticipated part of the decision \citep{altavilla2019, gurkaynak2005}. By interacting the pre-determined net positions of hedge funds with the shock, I estimate the additional yield sensitivity that arises when hedge funds are trading a given bond. I then use the full cross section of each fund's positions to show that the amplification depends on whether the bond sits within a hedged or directional book.

I document four main results. First, bonds held by hedge funds move more than comparable bonds when a shock hits. Hedge funds select into inherently more volatile bonds, and to account for that, I compare bonds of the same issuer, duration and date. On regular days there is no difference between the two groups, so this excess volatility reflects their positioning rather than the characteristics of the bonds they trade.

Second, the excess volatility arises because hedge fund trading amplifies the sensitivity of sovereign bond yields to shocks. This amplification scales with the fraction of the bond that hedge funds hold, with the same bond becoming more sensitive as their share rises. The dose response is consistent with a mechanical link between the volume of leveraged trading and the resulting price dislocation. Local projections show that the divergence in yields between bonds traded by hedge funds and comparable bonds appears immediately on the impact day, persists for approximately four trading days, and then reverts toward zero. This temporary overshooting indicates that hedge fund activity moves prices away from fundamentals in the short run, more consistent with the amplification view than with the view that hedge funds push prices toward fundamental value.

Third, the amplification operates regardless of whether shocks are favorable or unfavorable to the hedge fund's position. When the shock moves prices against the position, the mark-to-market loss erodes the fund's capital buffer and the fund may face margin calls that force it to reduce its exposure. When the shock moves prices in its favor, the gain adds to the capital buffer and frees up capacity, which the fund may use to expand its exposure. In both cases, the resulting trading would push yields further in the direction of the initial shock. Splitting the sample into a constraining and a relaxing regime confirms amplification in both states, and local projections verify that the two regimes correspond to position contractions and expansions. This pattern is consistent with \citet{adrian2014}, in which leveraged intermediaries manage their balance sheets in response to the risk environment and thereby keep their leverage ratio constant, expanding positions after gains and contracting them after losses.

Fourth, the amplification depends on the structure of the hedge fund book and not only on its size. Using the full cross section of each fund's positions, I measure whether a bond is held within a hedged book that offsets long and short positions in duration terms, as in a relative value trade that is long Italian and short German bonds, or within a one-sided directional book. The amplification is concentrated in bonds held within directional books and is essentially absent when the book is hedged. This locates the relevant capital constraint at the level of the fund's whole portfolio rather than the individual position. Because the sector alternates between directional and hedged configurations over time, the same volume of hedge fund positioning can pose very different amplification risks in different periods.

A first challenge in identifying the impact of hedge fund positioning is selection bias. Hedge funds do not select bonds randomly and the specific characteristics of those bonds may independently affect how strongly a bond reacts to a shock. I address this concern by introducing progressively tighter fixed effect specifications, up to duration-by-country-by-date fixed effects that compare bonds of similar duration from the same issuer on the same day, and by implementing a matched-sample design that pairs each hedge fund bond with the non-hedge fund bond in the same duration-country-date cell that is closest in terms of liquidity.

A second challenge is that any amplification could reflect the behavior of the dealers that intermediate hedge fund trades. If dealers respond to shocks in ways that systematically differ across the bonds where they maintain active hedge fund relationships, the results could capture dealer rather than hedge fund behavior. To provide evidence against this explanation, I use a dealer-bond-date panel, introduce increasingly demanding dealer fixed effect structures, and use credit default swaps to estimate whether the effect scales with dealer stress. The analysis confirms that the effect operates through hedge fund positioning, rather than the behavior of dealer banks.

My findings have several implications. The literature on leveraged intermediaries has focused on margin spirals, in which losses force liquidations during stress episodes \citep{brunnermeier2009, geanakoplos2010, adrian2010}. The amplification I find is two-sided, which suggests that the response to gains deserves the same attention as the response to losses. It is also not confined to crises but is present on any day with sizable price shocks. Similarly, models of sovereign bond pricing feature arbitrageurs who lean against imbalances \citep{greenwood2014, jansen2024}. My results suggest that allowing their demand to move with the shock would capture a further source of price pressure. For monetary policy transmission, part of the yield reaction on announcement days is a temporary positioning effect, so that estimates of pass-through partly reflect who holds the bond. For policymakers, neither the presence nor the size of hedge fund positions is sufficient to evaluate the risk. Monitoring should extend beyond stress episodes and treat the directionality of the book as a key risk metric, since the same position amplifies a shock within a directional book and is close to neutral within a hedged one.


\paragraph{Related literature.} This paper relates to at least three strands of the literature. The first examines the determinants of sovereign bond yields and their sensitivity to shocks. While sovereign bond yields are known to react to fundamental factors such as macroeconomic variables, debt sustainability or monetary policy, non-fundamental factors also play an important role. For example, \citet{degauwe2013} show that euro area sovereign spreads during the debt crisis reflected self-fulfilling dynamics disconnected from fundamentals. More broadly, the literature on slow-moving capital argues that temporary dislocations in asset prices can arise from frictions in the ability of arbitrageurs to absorb imbalances \citep{duffie2010, mitchell2007}. A related strand emphasizes the role of bond supply and investor demand in sovereign bond pricing. \citet{greenwood2014} show that shifts in the maturity-weighted supply of government debt move yields, consistent with arbitrageurs demanding compensation to absorb duration risk, while \citet{koijen2021} use granular holdings data to trace how different investors contribute to the transmission of ECB asset purchases. \citet{jansen2024} combine granular demand estimates with risk-averse arbitrageurs who absorb the imbalances that other investors leave behind. Because those investors substitute across maturities, monetary tightening raises term premia in their model. These papers show that sovereign yields are shaped not only by aggregate fundamentals, but also by marginal investors and the frictions that they face. This paper adds to this literature by documenting a specific source of temporary deviations from fundamental values in sovereign bond markets.

The second strand of the literature studies the role of non-bank financial intermediation, and in particular hedge funds, in financial markets. \citet{pelizzon2025nbfi} document the growth of non-bank financial intermediation in the euro area and the US, and \citet{aramonte2023} provide an overview of the types of NBFIs and the systemic risks they generate, arguing that the main risk associated with hedge funds is their reliance on leverage. Whether this implies that hedge funds are stabilizing or destabilizing for asset prices is an empirical question. On one hand, \citet{cao2018} find that hedge fund holdings are associated with improved price efficiency in equity markets, consistent with the view that hedge funds correct mispricings and enhance liquidity. In the gilt market, \citet{czech2021} show that hedge fund order flow forecasts returns over the following days, partly because funds anticipate the demand of other investors and partly because they process macroeconomic news more efficiently. On the other hand, a growing literature documents episodes in which leveraged hedge fund positioning has amplified stress. The March 2020 stress episode in US Treasury markets is the most prominent example. \citet{barth2025}, \citet{kruttli2025} and \citet{barone2023} document that the forced unwinding of leveraged hedge fund positions added to the selling pressure, and \citet{kashyap2025} use the episode to validate a model in which the interaction of leveraged hedge funds, capital constrained dealers and asset managers creates fragility that grows with the supply of Treasuries. Moreover, regarding the role of arbitrageurs in the euro area, \citet{anaya2025} show that investment funds rebalance away from periphery sovereigns in response to disaster risk. \citet{pelizzon2025} further show that asset scarcity induced by the ECB purchases impeded the arbitrage mechanism, generating mispricings. Related work studies the institutional infrastructure supporting hedge fund leverage, with \citet{dahlquist2023} and \citet{bittner2025} showing that hedge funds increasingly rely on multiple prime brokers to secure favorable margin terms and diversify idiosyncratic funding risk. This paper adds to this literature by documenting an amplification channel that is not confined to stress episodes and that operates whether a shock moves prices in favor of a position or against it. Its strength is governed by the directionality of the hedge fund book rather than only the size of the position.

The third strand of the literature studies the channels through which leveraged investors transmit shocks to asset prices. Foundational to this is the idea of limits to arbitrage, implying that sophisticated investors cannot perfectly respond to every shock \citep{shleifer1997, gromb2002}. A unifying perspective is provided by \citet{adrian2014}, who show that leveraged intermediaries actively manage their balance sheets in response to the risk environment, generating a constraining environment when adverse shocks tighten balance sheet constraints and a relaxing environment when favorable shocks loosen them. In the constraining environment, the response aligns with the literature on deleveraging spirals, in which adverse shocks erode the capital buffer, tighten funding constraints, and force position liquidations that further depress prices \citep{brunnermeier2009, geanakoplos2010, adrian2010, avalos2023}. Empirical evidence for this mechanism is largely concentrated in stress episodes. The same forced selling also arises from the interest rate hedges of pension funds and insurers. \citet{jansen2026} show that Dutch pension funds meet the margin calls on their swaps by selling government bonds, which depresses the prices of the bonds sold. \citet{alfaro2024} measure this liquidity risk from sterling repo and swap transactions and find that it predicts the bond sales that contributed to the yield spike in the 2022 gilt market crisis. In the relaxing environment, the response is not enforced by margin requirements. For arbitrageurs whose desired positions exceed what their balance sheets permit, expanding into the freed funding capacity is nonetheless the optimal response \citep{gromb2002, brunnermeier2009}, and hedge fund leverage is indeed documented to rise when asset values increase and funding costs fall \citep{ang2011}. The expansion can also reflect behavior unrelated to funding constraints, such as trend following or anticipatory trading. \citet{deLong1990} provide the theoretical foundation for the latter by showing that rational speculators may amplify price movements by anticipating the trading of less sophisticated investors. \citet{moskowitz2012} document time-series momentum across asset classes, and \citet{asness2013} extend this to a cross-sectional framework. \citet{brunnermeier2004} provide evidence that hedge funds engaged in momentum trading, riding the technology bubble rather than correcting it. This paper contributes by showing empirically that leveraged hedge fund positioning amplifies yields in both environments.
...
I use the European Central Bank’s Securities Financing Transactions Data Store (SFTDS) to identify hedge fund repo positions. This regulatory dataset, established under the Securities Financing Transactions Regulation (SFTR), provides a granular transaction-level view of the euro area repo market, covering all transactions involving at least one euro area-established entity. Given the dealer-intermediated nature of sovereign bond markets, and the global importance of euro area dealers, this dataset captures the large majority of repo activity in European sovereign bonds. My sample covers euro-denominated repo and reverse repo transactions collateralized by Italian and German sovereign bonds between January 2021 and November 2025.\footnote{Italian and German sovereign bonds account for approximately 70\% of absolute net daily hedge fund activity in euro area sovereigns. Appendix \ref{subsec:ext_val} re-estimates the main specifications on the expanded sample including French and Spanish sovereigns and finds consistent results.} 

I identify hedge funds in two steps. The sector-identification algorithm of \citet{lenoci2021} assigns each counterparty to a sector, which yields the population of investment funds. Within this population, I isolate offshore hedge fund activity by restricting the sample to funds domiciled in the Cayman Islands \citep[see][for a discussion on the relevance of Cayman Island domiciled hedge funds]{barth2025cross}, resulting in 152 identified hedge funds. I adopt the Cayman restriction as a conservative criterion for identifying hedge fund activity. Other common fund domiciles such as Ireland and Luxembourg host a broader mix of fund types, and restricting to Cayman therefore provides a cleaner sample. The restriction discards little activity. Across all counterparties classified as investment funds in the SFTDS, regardless of domicile, the 152 identified funds account for 91\% of gross outstanding repo positions in Italian and German sovereign bonds. Any bias from hedge funds among the remaining 9\% is downward, since adding them would only raise the measured hedge fund footprint in a bond. All 152 entities are hedge fund vehicles, as their legal names and manager affiliations show. The strategy classification in Appendix \ref{subsec:classification} goes one step further. Fixed income relative value and global macro funds, strategies for which the repo transaction is an integral part of the sovereign bond trade itself rather than a source of funding for unrelated positions, account for 85\% of their repo volume, and my results are unchanged when positioning is measured from these funds only. The few funds that remain unclassified lack a documented strategy, not a hedge fund identity.
...
Panel B highlights the significant footprint of offshore hedge funds. Hedge funds are active in the market, holding positions on 53\% of all bond-days. Crucially, the table distinguishes between the unconditional market footprint and the footprint conditional on hedge funds being active in the bonds. While the full-sample absolute net position averages 1.60\% of issuance, this figure rises to 3.01\% conditional on active participation. Thus, hedge funds hold economically meaningful fractions of the outstanding debt. The roughly symmetric split between long and short intensities (3.02\% vs. 3.00\% in the active sample) shows that hedge funds use these markets for both long and short positions.
...
\section{A Framework for Leveraged Positioning and Yield Amplification}
\label{sec:mechanism}

This section describes the framework that guides the empirical analysis. It traces how a price shock to a leveraged position affects the capital of the fund and, through the resulting position adjustment, the yield of the bond. The framework is intended to motivate the empirical design rather than to serve as a formal model. The empirical analysis is organized along its implications, and it is not meant to establish the framework as the only account of the results. Appendix \ref{subsec:calibration} presents a calibrated version of the framework based on sample moments.

The framework builds on \citet{adrian2014}, who describe leveraged intermediaries that manage their balance sheets in response to the risk environment and thereby, for a given level of risk, keep their leverage ratio constant. When asset values rise, leverage falls and the intermediary expands its positions. When asset values fall, leverage rises and the intermediary contracts them. The adjustment is therefore two-sided, and the direction of the shock determines the sign of the position adjustment. While \citet{adrian2014} focus on US broker-dealers, I apply this logic to hedge funds that finance bond positions through repo, where the margin requirement on the collateral bounds the leverage of the position.
...
\label{eq:capital}
\end{equation}
Shocks of the size observed in the sample have a substantial effect on the capital buffer. The average tightening surprise in the sample is approximately 6 basis points, which moves the price of a representative bond with a duration of about seven years by roughly 0.42\%. Under an effective margin of 2\%, which lies well above the haircuts reported in Table \ref{tab:summary_stats} and is therefore a conservative assumption, Equation (\ref{eq:capital}) implies that an average surprise moves the capital buffer by about 21\%. A fund that keeps its leverage constant would therefore adjust its position until leverage returns to its initial level, which requires a position change of the same proportion as the change in capital.

After a loss, the fund must reduce the position to restore the margin ratio, and the reduction is enforced by the margin call. After a gain, the fund can expand the position to the new capacity, and the expansion is voluntary. The contraction is the deleveraging response studied in the literature on funding constraints, in which losses erode capital and force position reductions \citep{brunnermeier2009, geanakoplos2010}. The expansion follows if the fund manages its leverage in the manner described by \citet{adrian2014}. It is also the optimal response of a constrained arbitrageur whose desired position exceeds its funding capacity. A favorable surprise enlarges the capacity while the remaining expected return may still justify a larger position than the enlarged balance sheet permits \citep{gromb2002}, and hedge funds are documented to raise leverage when asset values rise and funding costs fall \citep{ang2011}. The expansion would also arise under trend following, in which funds add to positions that have gained \citep{moskowitz2012, deLong1990}, and the empirical analysis does not distinguish between these motives. Appendix \ref{subsec:calibration} works through a numerical example of both sides. In both cases, the position adjustment is in the direction of the initial shock.

The yield reaction to the position adjustment depends on the market's ability to absorb it. The trading pressure equals the adjustment multiplied by the share of the bond that the hedge fund sector holds. Its price impact then depends on how elastic the demand for the bond is, meaning how much its yield reacts to trading pressure. The adjustment takes place within a short period after the shock, since margin calls are settled daily and the framework assumes that freed capacity is redeployed promptly rather than over months. The trading pressure is therefore concentrated in the days following the shock, and it reflects the adjustment of positions to the change in capital rather than a change in fundamentals.

In sum, the framework implies that bonds in which hedge funds hold leveraged positions react more strongly to a shock than comparable bonds, the more so the larger the position relative to the amount outstanding, that the additional reaction is temporary and reverts as other capital absorbs the imbalance, and that the amplification is two-sided, with a position contraction when the shock moves prices against the position and an expansion when it moves in its favor. Section \ref{subsec:amplification} examines the first two implications and Section \ref{subsec:asymmetries} the third. The results are read as consistent with the framework rather than as establishing it.
...
The interaction with the absolute shock behaves differently. It stays positive and stable between 0.240 and 0.253 across all four columns, surviving precisely the comparisons that eliminate the level differential. Hedge funds do select more volatile bonds, but the volatility they add appears only on days when a shock meets the position. Based on this evidence, the analyses throughout the paper use duration-by-country-by-date fixed effects as the preferred specification.

\subsection{Hedge Fund Amplification}
\label{subsec:amplification}
Turning to the yield reaction itself, this section establishes the amplification effect in four steps, documenting the differential sensitivity of bonds with hedge fund presence, tracing the persistence of the effect over the days after the shock, showing that its trigger lies with the funds rather than the dealers that intermediate their trades, and demonstrating that it scales with the size of the position.

\subsubsection{Hedge Fund Presence}
\label{subsec:baseline}
This paper argues that the trading activity of hedge funds matters for the sensitivity of a bond's yield. To show evidence of this, Figure \ref{fig:sensitivity} presents a binned scatterplot with the monetary policy shocks on the x-axis and daily yield changes on the y-axis. I then differentiate whether bonds are actively traded by hedge funds.
...
\midrule
\textit{Main Interaction} & & & & & \\
\textbf{HF Involved $\times$ Shock} & \textbf{0.288***} & \textbf{0.288***} & \textbf{0.287***} & \textbf{0.291***} & \textbf{0.302***} \\
 & (0.072) & (0.072) & (0.073) & (0.062) & (0.054) \\
\addlinespace
\textit{Direct Effects} & & & & & \\
Shock & 0.757*** & 0.757*** &  &  &  \\
 & (0.123) & (0.123) &  &  &  \\
HF Involved & 0.083** & 0.062 & $-$0.000 & $-$0.022 & $-$0.008 \\
...
Bid-Ask Spread & & $-$0.034 & $-$0.239*** & $-$0.257*** &  \\
 & & (0.086) & (0.085) & (0.075) &  \\
CTD Flag & & 0.157* & 0.033 & 0.010 & 0.007 \\
 & & (0.094) & (0.041) & (0.028) & (0.045) \\
\midrule
...
\midrule
Observations & 477,001 & 477,001 & 477,001 & 470,852 & 481,824 \\
R-squared & 0.033 & 0.033 & 0.569 & 0.737 & 0.844 \\
\bottomrule
\end{tabular}
\label{tab:baseline}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \caption{Demeaned level decomposition}
        \includegraphics[width=\textwidth]{Figures/IR_baseline_decomposition_overshoot.png}
        \label{fig:baseline_persistence_decomp}
    \end{subfigure}
    \caption*{\scriptsize \textit{Notes:} Panel (a) plots the estimated interaction coefficients $\beta_h$ from regressions of cumulative yield changes ($\Delta y_{t-1 \rightarrow t+h}$) on the interaction between the HF presence dummy and monetary policy shocks, representing the differential yield response (in bps) of HF-involved bonds relative to non-HF bonds. Panel (b) plots the cumulative yield response per basis point of shock separately for HF-involved bonds and their matched non-HF counterparts, both demeaned by the average response across the two groups over days 5 to 10 after the shock, so that positive values indicate trading above the level at which yields eventually settle. Both panels are based on the matched sample set-up. Shaded areas denote 90\% confidence intervals clustered by business date and bond. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{figure}
...
Figure \ref{fig:baseline_persistence} provides two insights. First, the pre-shock coefficients are flat and insignificant, which speaks to the concern about selection bias by providing evidence that hedge fund-involved bonds and their matched counterparts do not differ significantly in the days leading up to the announcement. Second, the divergence appears immediately on the impact day, remains statistically significant for approximately four trading days, and then reverts back toward zero by the end of the horizon. Figure \ref{fig:baseline_persistence_decomp} decomposes this differential by plotting each group's cumulative response relative to the average response across both groups over days 5 to 10 after the shock, the common level at which the reaction eventually settles. Hedge fund bonds trade above this settled level during the first days after the shock, while their matched counterparts approach it from below. Appendix \ref{subsec:level_decomposition} reports the undemeaned level responses, which converge toward a common terminal value of slightly below one basis point per basis point of shock. This gradual adjustment is consistent with theories of slow-moving capital in which the market requires time to absorb the imbalance generated by leveraged trading \citep{duffie2010, mitchell2007}.

If hedge funds were primarily correcting mispricings, their trading would push yields toward fundamental values and the effect would persist. Instead, Figure \ref{fig:baseline_persistence_decomp} shows that HF-involved bonds overshoot the settled level during the first days after the shock before reverting back, which is evidence of non-fundamental liquidity shocks \citep{coval2007}.
...
Taken together, the demeaned decomposition in Figure \ref{fig:baseline_persistence_decomp} and the shock decomposition in Table \ref{tab:jk} point to the same conclusion through independent channels. HF bonds overshoot their own terminal level during the first days after the shock, and the amplification is concentrated in pure monetary rather than information-driven surprises. Hedge fund activity moves prices away from fundamentals in the short run, and the dislocation is only gradually undone as other capital arrives. Within the sovereign bond market studied here, the evidence is therefore more consistent with the amplification view of leveraged non-bank trading than with the price-discovery view.
...
\subsubsection{The Role of Dealers}
...
Table \ref{tab:asymmetry} presents the results. In both regimes, the interaction coefficient is positive and statistically significant at the 1\% level. The constraining regime in Column (1) yields a coefficient of 0.140 and the relaxing regime in Column (2) yields a coefficient of 0.224. A Wald test of equality between the two coefficients, estimated in a pooled specification that explicitly compares the regimes, fails to reject the null ($p=0.16$). The two regimes are therefore statistically indistinguishable in the pooled sample.

The fact that the two coefficients are not statistically different indicates that hedge fund trading amplifies yields with comparable strength regardless of whether the shock is tightening or relaxing constraints. This is consistent with the framework in Section \ref{sec:mechanism}, where the same leveraged investor adjusts position size in opposite directions across the two regimes, with both adjustments pushing yields in the direction of the initial shock. Appendix \ref{subsec:side_book} splits the two regimes by the side of the position. The constraining-side response is the same for long and short positions, as a constraint that binds mechanically implies, while the relaxing-side response is present for both but largest for short positions on tightening surprises, consistent with the expansion being discretionary. To further assess this interpretation, I now investigate the dynamic response of hedge fund positioning itself to the shock, which allows me to verify whether the position adjustments of hedge funds align with the outlined mechanism.
...
The patterns are consistent with the implications of Section \ref{sec:mechanism}. In the constraining regime, the cumulative change in hedge fund intensity is negative, consistent with funds reducing exposure as the shock erodes their collateral buffer. In the relaxing regime, the opposite pattern emerges. Rather than reducing exposure, hedge funds expand their positioning when the policy surprise moves prices in their favor. The similar size of the contraction and the expansion is consistent with the single position rule of Section \ref{sec:mechanism}, under which a constrained fund adjusts its exposure with its margin capacity in both directions, whether because it keeps its leverage constant \citep{adrian2014} or because it redeploys freed capacity while its underlying view remains ahead of the market. The data do not distinguish between these readings, and since the expansion, unlike the contraction, is not forced, I interpret the relaxing-side evidence as consistent with the mechanism rather than as establishing it.

\section{Hedge Fund Directionality}
\label{sec:directionality}

Section \ref{subsec:asymmetries} establishes that the amplification is two-sided. Whether a fund is long or short, and whether the shock tightens or relaxes its constraint, the effect is present. A natural next question concerns the structure of the positions rather than their direction. Figure \ref{fig:HF_net} shows that the sector's net positions move between two configurations over the sample. In the periods around the hiking cycle the sector is net long Italian and net short German government bonds, so that the two legs partly offset. During the hiking cycle both legs sit on the short side and the net exposure becomes one-sided. This section asks whether that distinction shapes the amplification. I answer it within the empirical strategy of Section \ref{sec:empirical_strategy}, interacting hedge fund positioning with the shock under the same fixed effects, and add only a measure of how directional each fund's book is.
...
The mechanism in Section \ref{sec:mechanism} describes the capital constraint at the level of an individual position. A fund, however, manages a single pool of capital against its entire bond book, so a shock erodes its capital in proportion to the net exposure of the whole portfolio rather than the exposure of any single bond.\footnote{Positions are observed at the level of the individual legal entity, and margin in bilateral repo binds at the same level. Netting and collateral calls apply to each counterparty entity separately, and funds operated by the same manager are separately capitalized pools. A position that is offset in a sibling fund of the same manager therefore does not relieve a margin call on a fund's own book.} A fund that is long Italian and short German bonds of similar duration carries little net exposure to a parallel move in rates. A shock barely moves its capital and it has little reason to rebalance. A fund running a directional bond book absorbs the full capital loss and rebalances accordingly. The amplification that a given bond experiences should therefore depend on whether the funds holding it run a hedged or a directional bond book, and not only on how much they hold. A more hedged book corresponds to a higher effective margin in the mechanism of Section \ref{sec:mechanism}, so the directionality of a bond's holders is the cross-sectional counterpart to the single margin that Section \ref{sec:mechanism} assumes.
...
Two points of interpretation matter. First, every fund in the data is a hedge fund, so the distinction is not between hedged and unhedged institutions but between bonds held within a hedged bond book and bonds held within a directional bond book, set against a baseline of bonds without hedge fund activity. Second, I observe only the cash leg of these positions and not the strategy behind them, so hedged and directional describe the net duration exposure of the observed bond book and not a particular trade. If cross-product margining is applied, a book that looks directional in the cash market could in fact be hedged with derivatives that I do not observe, as is possible in the cash-futures basis trade. This does not bias the comparison. If the hedge insulates the fund, the book carries little net exposure to the shock, so its presence in the directional group only pulls the measured difference toward zero and the estimate is conservative. If instead the bonds and the futures are financed and cleared with different counterparties, the two legs are margined separately, so the bond leg may face its own margin call and trades like the directional position the measure already treats it as.

\begin{table}[t]
\centering
\caption{\textbf{The Hedge Fund Sector's Book by Year}}
\footnotesize
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c c c c}
\toprule
 & \multicolumn{4}{c}{Fund-level directionality} & & \\
\cmidrule(lr){2-5}
 & Mean & Median & Gross-w.\ Mean & Share $>$ 0.8 & Net Short Share & Coordination \\
\midrule
2021 & 0.66 & 0.77 & 0.46 & 0.48 & 0.41 & 0.68 \\
2022 & 0.66 & 0.76 & 0.53 & 0.49 & 0.69 & 0.92 \\
2023 & 0.55 & 0.49 & 0.35 & 0.37 & 0.79 & 0.92 \\
2024 & 0.51 & 0.36 & 0.20 & 0.38 & 0.65 & 0.48 \\
2025 & 0.47 & 0.33 & 0.13 & 0.33 & 0.52 & 0.28 \\
\bottomrule
\end{tabular}
\label{tab:fund_dir}
\caption*{\textit{Notes:} This table describes the configuration of the hedge fund sector's bond book by year, computed from 95,952 fund-day observations of between 102 and 116 funds active per year. \textit{Mean} and \textit{Median} summarize fund-level directionality, the fund's absolute net DV01 exposure over its gross DV01 exposure as defined in Section \ref{sec:directionality}, across fund-days. \textit{Gross-w.\ Mean} weights fund-days by gross DV01 exposure, so that large books count more. \textit{Share $>$ 0.8} is the share of fund-days with directionality above 0.8. \textit{Net Short Share} is the share of one-sided fund-days (directionality above 0.5) with negative net DV01, i.e.\ positioned for rising yields. \textit{Coordination} is the daily ratio of the absolute sum of fund net DV01 exposures to the sum of absolute fund net DV01 exposures, averaged within the year; it equals one when all net exposures point in the same direction and zero when they fully offset. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

Table \ref{tab:fund_dir} describes how the sector's configuration evolves at the level where capital is committed, the fund. Three facts stand out. First, the sector unwinds its net exposure over the sample. Weighting books by their gross exposure, average directionality falls from 0.53 in 2022 to 0.13 in 2025, and the decline is concentrated among the large books, since the equal-weighted mean falls far less. Second, during the hiking cycle the one-sided books point overwhelmingly in the same direction. Coordination reaches 0.92 in 2022 and 2023, and around three quarters of the one-sided books are net short duration. Third, by 2025 both margins have unwound. The large books are internally hedged, and the remaining one-sided books, mostly small ones, offset each other, with coordination at 0.28. Appendix Figure \ref{fig:holder_dir_ts} plots the corresponding bond-level aggregate over time. The bond-level measure also varies in the cross section, with an average within-cell standard deviation of about 0.11, but this dispersion is compressed precisely because the configuration moves largely as one, meaning on a given date, most books sit on the same side. The identification of the results that follow therefore draws on both cross-sectional and time-series variation, and Appendix \ref{subsec:dir_calendar} separates the two.
...
\vspace{1ex}
\raggedright\scriptsize
\textit{Notes:} The table reports the amplification of bond yields to monetary policy shocks as a function of the directionality of the hedge funds holding each bond. The dependent variable is the daily yield change in basis points. Holder directionality is the position weighted average across a bond's hedge fund holders of each fund's absolute net duration exposure over its gross duration exposure, measured over the five trading days before the shock and scaled to lie between zero and one. Column (1) interacts Log HF Intensity and the shock with holder directionality, with holder directionality entering only through the intensity term. Columns (2) and (3) compare bonds held by hedge funds, split at the median and into quartiles of holder directionality, against the baseline of bonds without hedge fund activity. The median and quartile cutoffs are computed over the pooled sample of hedge fund bond-days. Log HF Intensity is the natural log of one plus the average absolute net position over the prior five trading days scaled by amount outstanding. Shock is the change in the two year OIS rate during the ECB event window. All columns include the bid-ask spread and a CTD indicator as controls, bond fixed effects, and duration by country by date fixed effects, with the latter absorbing the shock main effect. A Wald test rejects equality of the hedged and directional coefficients in Column (2) with $F=24.8$ and equality of the extreme quartiles in Column (3) with $F=28.3$. Standard errors clustered by business date and bond in parentheses. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01
\end{table}

Because the directional configuration coincides with the hiking cycle, one might worry that holder directionality partly proxies for calendar time, with the hedged and directional groups drawing on different periods. Table \ref{tab:fund_dir} shows why this concern cannot be resolved by simply comparing bonds within a date. The sector's configuration moves largely as one, so in the crowded years there are few bonds held within hedged books to compare against, and in the calm years the remaining one-sided books are small and the surprises smaller. Appendix \ref{subsec:dir_calendar} separates the margins formally by giving every date its own hedge fund baseline. Three results emerge. First, the directional-hedged contrast among hedge fund bonds on the same date is close to zero on average, as the common configuration predicts, but increases significantly with the sector's exposure, reaching about 0.16 at hiking-cycle levels. Second, the amplification per unit of intensity remains significant under the same fixed effects, and third, at the announcement level, the amplification slope rises steeply with the sector's directionality while a 2022 indicator adds nothing. The amplification thus tracks the sector's book rather than the calendar. It is strong when exposed capital is large and aligned, and absent when books are hedged.

These results carry two implications. First, they sharpen the interpretation of the amplification. The effect appears only for bonds held within directional books, which is exactly where the leverage mechanism predicts a dislocation. This concentration is hard to reconcile with a price-discovery account, in which hedge fund trading would push yields toward fundamentals regardless of how the position sits within the book. Second, the result speaks to how the sector should be monitored. The effect of leveraged positioning is not captured by its size alone. The same amount of positioning amplifies a shock when it sits within a directional book and is close to neutral when it sits within a hedged book. Supervisors gauging the systemic footprint of hedge funds therefore need to account for the directionality of the book, and not only the gross size of the positions.
...
The estimates show that the amplification documented for monetary policy surprises is not specific to that shock. The interaction coefficients in the binary specification and in the continuous specification are of the same order of magnitude as the corresponding coefficients in the monetary baseline and carry the same sign and significance, even though the credit shock originates from an entirely different economic source and the two shocks are measured on different scales. Thus, this provides more evidence that the mechanism operates whenever a large price change meets pre-existing leveraged positioning, rather than being a feature of monetary announcements in particular. The regime split reinforces this reading. The interaction is 0.129 in the constraining regime and 0.117 in the relaxing regime, so the two are close in magnitude with the constraining side only slightly larger. This near equality provides independent support for the two-sided nature of the framework, since in the baseline analysis the point estimates in the two regimes appeared more dispersed even though they were not statistically distinguishable. Under this shock the two regimes deliver almost the same amplification, which is what the constant-leverage logic of Section \ref{sec:mechanism} predicts.


\section{Conclusion}
\label{sec:conclusion}
This paper uses a transaction-level dataset to document evidence for a non-bank amplification channel in sovereign bond markets. Even among comparable bonds, hedge funds add excess volatility on shock days but not on regular days. The leveraged positioning of offshore hedge funds amplifies the sensitivity of sovereign bond yields to monetary policy shocks, accounting for more than a quarter of the total yield movement on shock days. The amplification scales with the position's share of the bond's outstanding volume. It is also two-sided. Funds contract when a shock moves prices against their position and expand when it moves prices in their favor, and the amplification is present in both cases. The amplification is concentrated among bonds held within directional hedge fund books and is essentially absent when the book offsets its long and short positions, which places the binding constraint at the level of the fund's portfolio rather than the individual position.

A central concern when interpreting these results is that hedge funds may select bonds that are inherently more sensitive to shocks, and the first result shows that this selection is real. The estimates therefore rest on a sequence of progressively tighter identification strategies, up to duration-by-country-by-date fixed effects and a matched-sample design that pairs each hedge fund bond with its closest non-hedge fund counterpart. The amplification is stable across these specifications, is not driven by the dealers that intermediate the trades, and holds under a range of further robustness tests, including a credit shock constructed from Italian sovereign CDS spreads that shows the channel is not specific to monetary news. 

These findings relate to the broader question of how leveraged non-bank investors shape the dynamics of sovereign bond markets. The evidence presented here is more consistent with the amplification than with the price-discovery view. The leveraged positioning of hedge funds contributes to sovereign bond yields temporarily overshooting in response to shocks, with the dislocation only gradually reverting over subsequent days. These results isolate one specific channel and are not an overall assessment of hedge fund participation in these markets, which would also have to weigh contributions to aspects such as liquidity that this paper does not measure. What they do imply is that assessing the risks from hedge fund activity in sovereign bond markets requires granular information not only on the size of positions, but also on how they sit relative to the shock environment and on the directionality of the book.
...
\clearpage
\subsection{Hedge fund strategy classification}
\label{subsec:classification}

Table \ref{tab:fund_classification} reports the strategy composition of the 152 Cayman-domiciled hedge funds in the sample. Each fund is classified at the level of the transacting legal entity rather than the manager, since managers may operate several vehicles with different mandates. The classification proceeds in three steps. First, funds whose legal names contain an unambiguous strategy identifier are classified directly. Second, I link the remaining funds to their investment advisers through SEC Form ADV, on which advisers report each private fund they manage (Schedule D, Section 7.B.(1)), and classify a fund from the adviser's Form ADV Part 2A brochure whenever the brochure names the fund and describes its strategy. Third, funds whose advisers file no brochure or whose brochures do not identify the specific vehicle are classified from documented public sources, primarily regulatory filings and the managers' own published strategy descriptions, with the source recorded for each fund. Funds without sufficient evidence remain unclassified. Fixed income relative value and global macro funds, the strategies for which sovereign bond repo transactions form part of the position itself rather than a source of funding for unrelated trades, account for 63\% of funds and 85\% of repo volume, while unclassified funds account for a negligible share of volume. Appendix \ref{subsec:fimacro} shows that the main results are unchanged when positioning is measured exclusively from fixed income relative value and global macro funds. \\

\begin{table}[h!]
\centering
\caption{\textbf{Hedge Fund Strategy Composition}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c}
\toprule
Strategy & Number of Funds & Share of Funds (\%) & Share of Volume (\%) \\
\midrule
Fixed income / rates relative value & 54 & 35.5 & 72.4 \\
Multi-strategy & 29 & 19.1 & 14.6 \\
Global macro & 42 & 27.6 & 12.8 \\
Credit & 13 & 8.6 & 0.1 \\
Commodity & 1 & 0.7 & 0.0 \\
Equity & 2 & 1.3 & 0.0 \\
Unclassified & 11 & 7.2 & 0.0 \\
\midrule
Total & 152 & 100.0 & 100.0 \\
\bottomrule
\end{tabular}
\label{tab:fund_classification}
\caption*{\textit{Notes:} This table reports the strategy composition of the 152 Cayman-domiciled hedge funds in the sample, classified as described above. \textit{Share of Volume} is each strategy's share of the total gross repo volume of the 152 funds, computed as the sum of nominal transaction amounts across repo and reverse repo transactions collateralized by German and Italian sovereign bonds. Shares may not sum to 100 due to rounding. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

\clearpage
\subsection{Positioning from fixed income and macro funds only}
\label{subsec:fimacro}

Table \ref{tab:fimacro} re-estimates the main specifications with hedge fund positioning measured exclusively from funds classified as fixed income relative value or global macro in Appendix \ref{subsec:classification}. This addresses the concern that repo positions of other fund types need not reflect sovereign bond trades. A multi-strategy fund, for example, may post a bond in repo and use the cash to finance positions in other asset classes, in which case its repo activity proxies for funding demand rather than directional bond exposure. The estimated coefficients are nearly identical to the main specifications across the binary, continuous intensity, constraining, and relaxing regime tests. The amplification is therefore driven by funds that use the repo market to run leveraged sovereign bond positions. \\

\begin{table}[h!]
\centering
\caption{\textbf{Positioning from Fixed Income and Macro Funds Only}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c c}
...
\midrule
\textit{Main Interaction} & & & & \\
HF Involved $\times$ Shock & 0.292*** & & & \\
 & (0.062) & & & \\
Log HF Intensity $\times$ Shock & & 0.173*** & 0.147*** & 0.235*** \\
 & & (0.032) & (0.036) & (0.050) \\
\addlinespace
\textit{Direct Effects} & & & & \\
HF Involved & $-$0.030 & & & \\
 & (0.037) & & & \\
Log HF Intensity & & $-$0.003 & $-$0.009 & $-$0.001 \\
 & & (0.017) & (0.017) & (0.017) \\
\addlinespace
\textit{Controls} & & & & \\
Bid-Ask Spread & $-$0.256*** & $-$0.259*** & $-$0.257*** & $-$0.256*** \\
 & (0.074) & (0.074) & (0.074) & (0.074) \\
CTD Flag & 0.010 & 0.008 & 0.007 & 0.003 \\
 & (0.028) & (0.028) & (0.027) & (0.028) \\
\midrule
Bond FE & Yes & Yes & Yes & Yes \\
Duration $\times$ Date $\times$ Country FE & Yes & Yes & Yes & Yes \\
\midrule
Observations & 470,372 & 470,372 & 466,524 & 466,495 \\
R-squared & 0.738 & 0.738 & 0.734 & 0.735 \\
\bottomrule
\end{tabular}
\label{tab:fimacro}
\caption*{\textit{Notes:} This table re-estimates the main specifications with hedge fund positioning measured exclusively from funds classified as fixed income relative value or global macro. The dependent variable is the daily change in bond yield (bps). \textit{HF Involved} indicates the presence of repo activity by these funds. \textit{Log HF Intensity} is the natural log of one plus their average absolute net position over the prior five trading days, scaled by the bond's total amount outstanding. Bond-days on which only hedge funds of other strategy types are active are excluded from the sample. Column (1) corresponds to Column (4) in Table \ref{tab:baseline}, Column (2) to Column (4) in Table \ref{tab:intensity}, and Columns (3) and (4) to Columns (1) and (2) in Table \ref{tab:asymmetry}. The Shock main effect is absorbed by the fixed effects. Standard errors are clustered by date and bond and reported in parentheses. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}


\clearpage
\subsection{Calibrated example of the amplification mechanism}
\label{subsec:calibration}

This appendix works through the framework of Section \ref{sec:mechanism} with representative sample moments. It first quantifies the constraining side, then the relaxing side, and finally compares the implied amplification with the estimates of Section \ref{subsec:amplification}. The purpose of the example is to assess whether the mechanism can generate amplification of the order of magnitude observed in the data. It is not an estimate.

The average monetary policy tightening surprise in the sample is approximately 6 basis points. Regarding leverage, the transaction data in Table \ref{tab:summary_stats} shows haircuts averaging 0.24\% for long positions. However, these raw figures may understate the true capital committed by funds due to practices such as portfolio margining, netting, unobserved cash buffers, or hedging activity that reduces the net price exposure relative to the raw repo position \citep{hempel2023, hill2025, hermes2025a}. Therefore, to capture these effects in a stylized way, I assume an effective margin ($m_i$) of 2\%. The representative sovereign bond has a duration of approximately 7 years, and the hedge fund sector is assumed to hold 3\% of its total outstanding volume ($Q_{HF}/Q_{Total} = 0.03$), in line with the conditional sample in Table \ref{tab:summary_stats}.

Consider first the constraining side. A positive monetary policy shock of 6 basis points induces a price decline of approximately $0.42\%$ ($6\text{ bps} \times 7$) for a fund holding the representative bond financed via repo under the 2\% margin assumption. Substituting these values into Equation (\ref{eq:capital}) gives the change in the capital buffer.
...
Recall that the exogenous price change necessitates adjusting the position by 21\%. With the hedge fund sector holding 3\% of the bond, the aggregate trading pressure amounts to

\begin{equation*}
\text{Trading pressure} = 21\% \times 3\% = 0.63\% \text{ of outstanding debt}
\end{equation*}

To quantify the yield impact, I choose a market elasticity of $\lambda = 5$ basis points per percentage point of outstanding traded, based on empirical estimates for US and euro area sovereign bond markets \citep{damico2013, eser2016, desantis2020}. Substituting these parameters into Equation (\ref{eq:pressure}) yields the total amplification.
...
The requirement to keep meeting margin makes the constraining side mechanical. The relaxing side is not. When the same 6 basis point surprise moves in favor of the position, the bond gains $0.42\%$, the fund receives the corresponding variation margin in cash, and its capital buffer rises by 21\%. Nothing compels the fund to redeploy this capacity, so the expansion on the relaxing side cannot be taken for granted.

To see when redeployment is nonetheless the optimal response, consider the same fund when its position reflects a view on the path of policy rates. Suppose the fund expects the yield of the seven year bond to fall 25 basis points below what is currently priced and holds the bond at the maximum size its margin permits. In analogy to Equation (\ref{eq:capital}), the position then offers

\begin{equation*}
\text{Expected return on capital} = \frac{25\text{ bps} \times 7}{2\%}
= \frac{1.75\%}{2\%} \approx 88\%
\end{equation*}

\noindent The numerator is the expected price gain and the denominator is the margin capital backing the position. Such a return puts the position at the funding constraint rather than at an interior optimum. The fund would hold more if its capacity allowed it.

A favorable 6 basis point surprise then does two things at once. It consumes 6 of the 25 expected basis points and it raises the fund's capacity by 21\%. The remaining gap still offers

\begin{equation*}
\text{Expected return on capital} = \frac{19\text{ bps} \times 7}{2\%}
= \frac{1.33\%}{2\%} \approx 66\%
\end{equation*}

\noindent so the position justified by the view continues to exceed what the balance sheet permits. Expanding to the new capacity is the optimal response, and the fund buys an additional 21\% of its position, the same magnitude that the capital erosion forces on the constraining side. As long as the view stays ahead of the market, capacity is the binding limit, and favorable and unfavorable shocks move the position by the same proportion with opposite sign. Once yields reach the view, the expected return is exhausted. The fund stops adding and eventually unwinds, so the expansion ends on its own. Under the same market elasticity, the expansion generates the same trading pressure as the contraction and an additional yield move of 3.15 basis points in the direction of the shock.

The size of the expansion relative to the gain in capital merits comment. The fund adds bonds worth fifty times its capital gain. The multiplier is the leverage ratio $1/m_i$, and it is the same multiplier that turns a 0.42\% price loss into a 21\% position reduction on the constraining side. The two-sided response therefore follows from the leverage of the position and not from an additional assumption.

Finally, the calibrated amplification can be compared with the estimates of Section \ref{subsec:amplification}. The binary interaction coefficient of 0.288 in Table \ref{tab:baseline} implies an additional yield move of approximately 1.73 basis points for a 6 basis point surprise, and the intensity specification in Table \ref{tab:intensity} implies approximately 1.36 basis points at an average intensity of 3\%. The calibrated value of 3.15 basis points is of the same order of magnitude and lies within a factor of two of the estimates. Given the stylized parameters, in particular the effective margin and the market elasticity, the example indicates that the mechanism can generate amplification of the observed order of magnitude, but it does not provide a quantitative prediction. A higher effective margin or a deeper market would lower the calibrated value toward the estimates.



\clearpage
\subsection{Exceedance probability of Monetary Policy Shocks}
\label{subsec:exceedance_mp}
...
\clearpage
\subsection{Alternative duration bin widths}
\label{subsec:bin_width}

The duration-by-country-by-date cells used throughout the paper are built from two-year duration bins. Within these cells, duration still varies. The average within-cell standard deviation of duration is 0.53 years under the baseline two-year bins, 0.26 years under one-year bins, and 0.83 years under three-year bins. Table \ref{tab:bin_width} shows that the estimates do not depend on this choice. It re-estimates the four main specifications, corresponding to Column (4) of Table \ref{tab:baseline}, Column (4) of Table \ref{tab:intensity}, and Columns (1) and (2) of Table \ref{tab:asymmetry}, with the two-year bins replaced by one-year bins in Panel A and three-year bins in Panel B. The binary interaction is 0.282 with one-year bins and 0.294 with three-year bins, compared to 0.291 in the baseline, and the intensity, constraining, and relaxing coefficients move equally little. Finer bins mechanically produce more single-bond cells, which drop out of the estimation, so the sample is somewhat smaller in Panel A. The stability of the coefficients while the within-cell dispersion varies threefold across bin widths shows that neither the width of the bins nor the residual duration heterogeneity within cells drives the amplification. \\

\begin{table}[h!]
\centering
\caption{\textbf{Alternative Duration Bin Widths}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c c}
...
\cmidrule(lr){2-5}
 ...
 & & & Constraining & Relaxing \\
\midrule
\multicolumn{5}{l}{\textit{Panel A: One-year duration bins}} \\
\addlinespace
HF Involved $\times$ Shock & 0.282*** & & & \\
 & (0.062) & & & \\
Log HF Intensity $\times$ Shock & & 0.155*** & 0.120*** & 0.218*** \\
 & & (0.032) & (0.036) & (0.049) \\
HF Involved & $-$0.024 & & & \\
 & (0.039) & & & \\
Log HF Intensity & & $-$0.014 & $-$0.018 & $-$0.013 \\
 & & (0.015) & (0.015) & (0.015) \\
Observations & 466,815 & 466,815 & 462,923 & 462,913 \\
R-squared & 0.760 & 0.760 & 0.757 & 0.758 \\
\midrule
\multicolumn{5}{l}{\textit{Panel B: Three-year duration bins}} \\
\addlinespace
HF Involved $\times$ Shock & 0.294*** & & & \\
 & (0.064) & & & \\
Log HF Intensity $\times$ Shock & & 0.168*** & 0.145*** & 0.221*** \\
 & & (0.032) & (0.039) & (0.051) \\
HF Involved & $-$0.023 & & & \\
 & (0.039) & & & \\
Log HF Intensity & & $-$0.019 & $-$0.024 & $-$0.015 \\
 & & (0.016) & (0.016) & (0.016) \\
Observations & 474,658 & 474,658 & 470,786 & 470,773 \\
R-squared & 0.721 & 0.721 & 0.717 & 0.718 \\
\midrule
Bond FE & Yes & Yes & Yes & Yes \\
Duration Bin $\times$ Date $\times$ Country FE & Yes & Yes & Yes & Yes \\
Bid-Ask Spread and CTD Controls & Yes & Yes & Yes & Yes \\
\bottomrule
\end{tabular}
\label{tab:bin_width}
\caption*{\textit{Notes:} This table re-estimates the main specifications with the two-year duration bins underlying the duration-by-country-by-date fixed effects replaced by one-year bins (Panel A) and three-year bins (Panel B). Column (1) corresponds to Column (4) in Table \ref{tab:baseline}, Column (2) to Column (4) in Table \ref{tab:intensity}, and Columns (3) and (4) to Columns (1) and (2) in Table \ref{tab:asymmetry}. \textit{HF Involved} indicates the presence of offshore hedge fund repo activity. \textit{Log HF Intensity} is the natural log of one plus the average absolute hedge fund net position over the prior five trading days, scaled by the bond's total amount outstanding. All specifications include bond fixed effects, duration-bin-by-date-by-country fixed effects, and controls for bid-ask spread and CTD status. The Shock main effect is absorbed by the fixed effects. Cells containing a single bond drop out of the estimation, so the sample is smaller under finer bins. Standard errors are clustered by business date and bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

\clearpage
\subsection{Matched-pair balance}
\label{subsec:pair_balance}

Table \ref{tab:pair_balance} describes the matched sample underlying Column (5) of Table \ref{tab:baseline}. Each pair consists of a bond with active hedge fund repo positions on a given day and the non-hedge fund bond from the same duration-country-date cell that is closest in terms of bid-ask spread. The matched sample comprises 240,912 pairs, formed from 471 distinct hedge fund bonds and 582 distinct control bonds across 1,242 trading days. In the median pair, the hedge fund bond has a duration of 4.1 years and a bid-ask spread of 0.05 \euro\ and its control bond a duration of 4.0 years and a spread of 0.13 \euro. The median within-pair duration gap is 0.55 years, and half of all pairs are matched to within 0.05 \euro\ of bid-ask spread, a quarter to within 0.004 \euro.

Duration, the characteristic that governs a bond's mechanical sensitivity to rate shocks, is closely balanced, with a standardized difference of 0.03. The remaining rows reflect the selection documented in Table \ref{tab:hf_selection}. Hedge fund bonds are more liquid than their matched controls, are concentrated in larger issues, and carry a somewhat longer residual maturity at the same duration, which reflects coupon differences rather than differences in rate exposure. Because the hedge fund bond is typically the most liquid bond of its cell, the matched control is the closest feasible comparison but remains less liquid in the average pair. The two bonds differ in cheapest-to-deliver status in 6.4\% of pairs. CTD status is controlled for in all specifications, and Appendix \ref{subsec:ctd} shows that the results hold when CTD bonds are excluded entirely. 

\begin{table}[h!]
\centering
\caption{\textbf{Matched-Pair Balance}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c c c}
\toprule
 & HF Bond & Non-HF Bond & Mean Diff. & Median $|$Diff.$|$ & Std. Diff. \\
\midrule
Duration (years) & 5.46 & 5.31 & 0.15 & 0.55 & 0.03 \\
Residual Maturity (years) & 6.66 & 5.39 & 1.27 & 0.79 & 0.20 \\
Amount Issued (\euro\ bn) & 19.81 & 11.36 & 8.45 & 8.28 & 1.43 \\
Bid-Ask Spread (\euro) & 0.08 & 0.20 & $-$0.13 & 0.05 & $-$0.83 \\
\midrule
Pairs & \multicolumn{5}{c}{240,912} \\
Distinct HF bonds & \multicolumn{5}{c}{471} \\
Distinct non-HF bonds & \multicolumn{5}{c}{582} \\
Distinct dates & \multicolumn{5}{c}{1,242} \\
CTD mismatch rate & \multicolumn{5}{c}{6.4\%} \\
\bottomrule
\end{tabular}
\label{tab:pair_balance}
\caption*{\textit{Notes:} This table reports balance statistics for the matched sample used in Column (5) of Table \ref{tab:baseline}. Each hedge fund bond-day is paired with the non-hedge fund bond in the same duration-country-date cell that is closest in terms of bid-ask spread, with replacement. \textit{HF Bond} and \textit{Non-HF Bond} report the means of each characteristic. \textit{Mean Diff.} and \textit{Median $|$Diff.$|$} refer to the within-pair difference (HF minus non-HF) and the absolute within-pair difference. \textit{Std. Diff.} is the mean difference divided by the square root of the average of the two group variances. The \textit{CTD mismatch rate} is the share of pairs in which the two bonds differ in cheapest-to-deliver status. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

Table \ref{tab:pair_quality} shows that these residual within-pair differences do not drive the amplification. Column (1) repeats the matched-sample specification of Table \ref{tab:baseline} on the full matched sample. Columns (2) to (4) restrict the sample to increasingly tightly matched pairs, with within-pair bid-ask differences below 0.10 \euro, below the median difference of 0.05 \euro, and below the 25th-percentile difference of 0.004 \euro, the latter constituting near-exact liquidity matches. If residual liquidity differences drove the estimate, the coefficient should fall as the pairs become tighter. Instead, it ranges between 0.31 and 0.41 and never falls below the full-sample estimate. Column (5) allows the yield response to the shock to vary with the bid-ask spread on the full matched sample. The liquidity interaction is positive and statistically insignificant, indicating that, if anything, less liquid bonds react more strongly to shocks. Since the hedge fund bond is the more liquid side of almost every pair, residual liquidity mismatch biases the estimated amplification toward zero, and the hedge fund interaction indeed rises to 0.35 once liquidity-dependent shock sensitivity is absorbed. Column (6) additionally allows the shock response to vary with residual maturity and amount issued, so that the hedge fund interaction is identified only from variation in hedge fund status among bonds with comparable exposure to all characteristics in which the pairs are imbalanced. The coefficient is 0.376 and remains significant at the 1\% level, while none of the characteristic interactions is statistically distinguishable from zero. The amplification attaches to the hedge fund position itself rather than to the characteristics of the bonds hedge funds select. \\

\begin{table}[h!]
\centering
\caption{\textbf{Matched-Sample Robustness: Pair Quality and Bond Characteristics}}
\footnotesize
\setlength{\tabcolsep}{5pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c c c c}
\toprule
\textbf{Dependent Variable:} & \multicolumn{6}{c}{\textbf{$\Delta$ Bond Yield (bps)}} \\
\cmidrule(lr){2-7}
 & (1) & (2) & (3) & (4) & (5) & (6) \\
Pairs included & All & Gap $\leq$ 0.10 & Gap $\leq$ 0.05 & Gap $\leq$ 0.004 & All & All \\
\midrule
\textit{Main Interaction} & & & & & & \\
HF Involved $\times$ Shock & 0.302*** & 0.406*** & 0.387*** & 0.310*** & 0.347*** & 0.376*** \\
 & (0.054) & (0.076) & (0.075) & (0.050) & (0.065) & (0.082) \\
\addlinespace
\textit{Direct Effect} & & & & & & \\
HF Involved & $-$0.008 & $-$0.016 & 0.006 & $-$0.001 & $-$0.023 & $-$0.018 \\
 & (0.025) & (0.030) & (0.029) & (0.033) & (0.030) & (0.030) \\
\addlinespace
\textit{Characteristic Interactions} & & & & & & \\
Bid-Ask Spread $\times$ Shock & & & & & 0.382 & 0.313 \\
 & & & & & (0.263) & (0.272) \\
Residual Maturity $\times$ Shock & & & & & & $-$0.005 \\
 & & & & & & (0.010) \\
Amount Issued $\times$ Shock & & & & & & $-$0.003 \\
 & & & & & & (0.005) \\
\midrule
Matched Pair FE & Yes & Yes & Yes & Yes & Yes & Yes \\
CTD Flag Control & Yes & Yes & Yes & Yes & Yes & Yes \\
Characteristic Main Effects & No & No & No & No & Yes & Yes \\
\midrule
Observations & 481,824 & 285,936 & 240,456 & 126,300 & 481,824 & 481,824 \\
R-squared & 0.844 & 0.775 & 0.756 & 0.712 & 0.844 & 0.844 \\
\bottomrule
\end{tabular}
\label{tab:pair_quality}
\caption*{\textit{Notes:} This table re-estimates the matched-sample specification of Column (5) in Table \ref{tab:baseline}. The dependent variable is the daily change in bond yield (bps). \textit{HF Involved} indicates the hedge fund side of each matched pair. \textit{Gap} refers to the absolute within-pair difference in bid-ask spread (\euro) at the time of matching. The thresholds in Columns (3) and (4) correspond to the median and the 25th percentile of the gap distribution. Columns (5) and (6) use the full matched sample and allow the yield response to the shock to vary with the bid-ask spread, and additionally with residual maturity and amount issued. The main effects of the interacted characteristics are included. The Shock main effect is absorbed by the matched-pair fixed effects. Standard errors are clustered by Duration $\times$ Date $\times$ Country and non-HF bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

A final feature of the matched design is that pairs are re-formed every day, so the comparison bond attached to a given hedge fund bond changes over time. Partner turnover is indeed substantial. The partner changes on 41\% of consecutive matched days, between consecutive announcement days the typical hedge fund bond keeps the same partner only 29\% of the time, and the median hedge fund bond is matched on 373 days to 22 distinct partners, with its most frequent partner accounting for 23\% of its matched days. Table \ref{tab:match_stability} shows that this re-matching does not drive the estimate. Each hedge fund bond is instead assigned a single fixed comparison bond for the entire sample, either the control it is matched to most often under the baseline procedure (Column 1) or the control from its first matched day (Column 2). Pair-days on which the fixed partner has no data or carries hedge fund positions itself are dropped, which costs about a quarter of the pair-days, and the fixed pair no longer needs to occupy the same duration cell on every day. The interaction coefficient is 0.252 with modal partners and 0.288 with first partners, both significant at the 1\% level and within one standard error of the baseline estimate of 0.302. The slightly lower point estimates are consistent with fixed partners being coarser comparisons than the daily nearest match, and confirm that the amplification does not depend on how or when the comparison bond is re-selected. \\

\begin{table}[h!]
\centering
\caption{\textbf{Matched-Sample Robustness: Fixed Partners}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c}
...
\cmidrule(lr){2-3}
 & (1) & (2) \\
Fixed partner & Modal & First \\
\midrule
HF Involved $\times$ Shock & 0.252*** & 0.288*** \\
 & (0.092) & (0.069) \\
HF Involved & 0.002 & 0.003 \\
 & (0.020) & (0.012) \\
\midrule
Pair-Day FE & Yes & Yes \\
CTD Flag Control & Yes & Yes \\
\midrule
Pair-days & 185,622 & 171,902 \\
Observations & 371,244 & 343,804 \\
R-squared & 0.873 & 0.869 \\
\bottomrule
\end{tabular}
\label{tab:match_stability}
\caption*{\textit{Notes:} This table re-estimates the matched-sample specification of Column (5) in Table \ref{tab:baseline} with each hedge fund bond assigned a single fixed comparison bond over the whole sample instead of the day-specific nearest match. In Column (1) the fixed partner is the control bond that the hedge fund bond is matched to on the most days under the baseline procedure. In Column (2) it is the control bond from the hedge fund bond's first matched day. Pair-days on which the fixed partner has no data or carries hedge fund repo positions itself are excluded. \textit{HF Involved} indicates the hedge fund side of each pair. Pair-day fixed effects absorb the Shock main effect. Standard errors are clustered by Duration $\times$ Date $\times$ Country and partner bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

\clearpage
\subsection{Announcement-level evidence}
\label{subsec:announcement}

The identification of the amplification coefficient rests on 38 ECB announcements. This section shows that the estimate is broad-based across these announcements rather than generated by a few influential meetings. Figure \ref{fig:announcement_scatter} collapses the matched sample to one point per announcement, the average matched difference in daily yield changes between hedge fund bonds and their paired controls, plotted against the monetary policy surprise. The relationship is visible across the full range of surprises, in the interior of the distribution as well as in the tails. The slope of this announcement-level regression is 0.308 with a robust standard error of 0.072, nearly identical to the matched panel estimate of 0.302 in Table \ref{tab:baseline}, and it is not drawn by the extreme meetings. Excluding the two largest absolute surprises, the slope is 0.264 with a t-statistic of 4.0.

Two formal exercises confirm the visual impression. First, I re-estimate the baseline specification of Column (4) in Table \ref{tab:baseline} 38 times, dropping one announcement day at a time. The interaction coefficient ranges from 0.244, when the December 2022 meeting with the largest surprise of the sample is excluded, to 0.308, and every estimate remains significant at the 1\% level. No single announcement is necessary for the result.

Second, randomization inference addresses the concern that conventional standard errors overstate precision when the shock takes only 38 effective draws. Under the null hypothesis that hedge fund positioning does not amplify monetary policy surprises, the announcement dates are arbitrary relative to the daily matched differential. I therefore draw, within each calendar year, as many placebo days from the non-announcement days as there are actual announcements, assign them that year's actual surprise values, and re-estimate the announcement-level slope. The within-year draws ensure that the placebo dates face the same volatility environment as the actual announcements. Figure \ref{fig:ri_distribution} plots the distribution of placebo slopes across 1,000 permutations. The distribution is centered at zero with a standard deviation of 0.045, and the largest placebo slope in absolute value is 0.157, about half the actual estimate. No permutation reaches the actual slope of 0.308, corresponding to an exact permutation p-value below 0.001. The amplification is thus tied to the actual announcement dates and their surprises, not to the number of draws or to distributional assumptions underlying the clustered standard errors. \\

\begin{figure}[h!]
\centering
\caption{Announcement-Level Amplification}
\includegraphics[width=\textwidth]{Figures/Announcement_scatter.png}
\caption*{\scriptsize \textit{Notes}: Each point is one of the 38 ECB announcements in the sample. The vertical axis is the average matched difference in daily yield changes between hedge fund bonds and their paired non-hedge fund controls on the announcement day (bps). The horizontal axis is the monetary policy surprise, measured as the change in the 2-year OIS rate during the ECB event window (bps). The line is the unweighted linear fit. Its slope is 0.308 with a robust standard error of 0.072, and a pair-weighted fit gives 0.305. \\ Sample period: 2021-01-01 -- 2025-11-01}
\label{fig:announcement_scatter}
\end{figure}

\begin{figure}[h!]
\centering
\caption{Randomization Inference on the Announcement Dates}
\includegraphics[width=\textwidth]{Figures/RI_distribution.png}
\caption*{\scriptsize \textit{Notes}: The histogram shows the distribution of announcement-level slopes across 1,000 permutations in which the actual monetary policy surprises are assigned to randomly drawn non-announcement days from the same calendar year. The vertical line marks the actual announcement-level slope of 0.308. No placebo slope reaches the actual estimate in absolute value, corresponding to an exact permutation p-value below 0.001. \\ Sample period: 2021-01-01 -- 2025-11-01}
...
\clearpage
\subsection{Level decomposition of the persistence}
\label{subsec:level_decomposition}

Figure \ref{fig:baseline_persistence_levels} reports the level responses underlying the demeaned decomposition in Figure \ref{fig:baseline_persistence_decomp} in the main text. The cumulative yield response per basis point of shock is plotted separately for HF-involved bonds and their matched non-HF counterparts. Both series converge toward a common terminal value of slightly below one basis point per basis point of shock. Hedge fund bonds overshoot this level during the first days after the shock while their matched counterparts approach it from below, which is the pattern that the demeaned representation in the main text makes explicit.

\begin{figure}[h!]
\centering
\caption{Persistence of the amplification in levels}
\includegraphics[width=\textwidth]{Figures/IR_baseline_decomposition.png}
\vspace{-3mm}
\caption*{\scriptsize \textit{Notes:} The figure plots the cumulative yield response per basis point of shock separately for HF-involved bonds and their matched non-HF counterparts, based on the matched sample set-up. Shaded areas denote 90\% confidence intervals clustered by business date and bond. \\ Sample period: 2021-01-01 -- 2025-11-01}
\label{fig:baseline_persistence_levels}
\end{figure}
...
\clearpage
\subsection{Directionality and calendar time}
\label{subsec:dir_calendar}

The directionality results in Section \ref{sec:directionality} split hedge fund bonds at cutoffs computed over the pooled sample. Because the sector's configuration trends over the sample, the groups draw unevenly on different periods. Of the directional group's bond-days, 40\% fall in 2022 and 91\% in 2021--2023, while 69\% of the hedged group's bond-days fall in 2024--2025. This raises the concern that the directionality contrast partly reflects calendar time rather than the configuration of the books. This appendix separates the two. Figure \ref{fig:holder_dir_ts} plots the aggregate path of the bond-level measure that generates the composition tilt. \\
...
Table \ref{tab:same_date} augments the fixed effects of the baseline specification with hedge-fund-presence-by-date fixed effects. Because the shock is constant within a date, these absorb, date by date, both the level and the shock response of hedge fund bonds relative to non-hedge fund bonds, so that identification comes exclusively from differences among hedge fund bonds on the same date. Column (1) shows that the unconditional same-date contrast between directional-held and hedged-held bonds is small and statistically insignificant. This is what the common configuration implies. On most dates, the books holding different bonds are similarly exposed, so there is little to compare. Column (2) lets the contrast vary with the sector's exposure, measured as the position-weighted average of holder directionality across bonds on each date, the pre-shock counterpart of the series in Figure \ref{fig:holder_dir_ts}. The triple interaction is 0.700 and significant. The same-date contrast is absent when the sector is hedged and reaches approximately 0.16 at hiking-cycle levels of exposure, exactly when the mechanism predicts that directional books face binding constraints. Column (3) shows that the amplification per unit of hedge fund intensity survives the same fixed effects at 0.067, significant at the 1\% level. On the same date, among hedge fund bonds, those with larger positions react more strongly, a comparison in which calendar time plays no role. \\

\begin{table}[h!]
\centering
\caption{\textbf{Same-Date Identification of the Directionality Contrast}}
\footnotesize
\setlength{\tabcolsep}{8pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c c}
...
\cmidrule(lr){2-4}
 & (1) & (2) & (3) \\
\midrule
Directional-held $\times$ Shock & 0.054 & 0.031 & \\
 & (0.042) & (0.031) & \\
Directional-held $\times$ Shock $\times$ Sector Dir.\ & & 0.700** & \\
 & & (0.287) & \\
Directional-held $\times$ Sector Dir.\ & & $-$0.035 & \\
 & & (0.197) & \\
Directional-held & 0.007 & 0.005 & \\
 & (0.021) & (0.021) & \\
Log HF Intensity $\times$ Shock & & & 0.067*** \\
 & & & (0.024) \\
Log HF Intensity & & & $-$0.010 \\
 & & & (0.016) \\
\midrule
Bond FE & Yes & Yes & Yes \\
Duration $\times$ Date $\times$ Country FE & Yes & Yes & Yes \\
HF $\times$ Date FE & Yes & Yes & Yes \\
\midrule
Observations & 472,318 & 459,196 & 472,318 \\
R-squared & 0.748 & 0.749 & 0.748 \\
\bottomrule
\end{tabular}
\label{tab:same_date}
\caption*{\textit{Notes:} The dependent variable is the daily change in bond yield (bps). \textit{Directional-held} indicates hedge fund bonds with holder directionality above the pooled median, as in Table \ref{tab:directionality}. \textit{Sector Dir.}\ is the position-weighted average of holder directionality across bonds on each date, demeaned. Its main effect and its interaction with the shock are constant within a date and absorbed by the fixed effects, as is the Shock main effect. \textit{HF $\times$ Date FE} interact an indicator for hedge fund presence with the date, absorbing each date's level and shock response of hedge fund bonds relative to non-hedge fund bonds. All columns include the bid-ask spread and a CTD indicator as controls. Column (2) is restricted to dates with a defined sector directionality. Standard errors are clustered by business date and bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}

Table \ref{tab:regime} tests the time-series margin directly at the announcement level, using the per-announcement matched differential of Appendix \ref{subsec:announcement}. Column (1) regresses the differential on the surprise, the surprise interacted with sector directionality, and the level of sector directionality. The amplification slope at the average configuration is 0.214, and the interaction of 0.797 implies a slope of effectively zero in the most hedged regime and approximately 0.43 in the most directional one. Column (2) adds the surprise interacted with a 2022 indicator. The directionality interaction is essentially unchanged at 0.765, while the 2022 interaction enters at 0.012 and is indistinguishable from zero. The variation in amplification across announcements is explained by the configuration of the sector's books, not by the calendar year in which the largest surprises happened to occur. \\

\begin{table}[h!]
\centering
\caption{\textbf{Announcement-Level Amplification and the Sector's Book}}
\footnotesize
\setlength{\tabcolsep}{10pt}
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{l c c}
\toprule
\textbf{Dependent Variable:} & \multicolumn{2}{c}{\textbf{Matched HF Differential (bps)}} \\
\cmidrule(lr){2-3}
 & (1) & (2) \\
\midrule
Surprise & 0.214*** & 0.209*** \\
 & (0.045) & (0.064) \\
Surprise $\times$ Sector Dir.\ & 0.797*** & 0.765*** \\
 & (0.248) & (0.269) \\
Surprise $\times$ 2022 & & 0.012 \\
 & & (0.137) \\
Sector Dir.\ & 5.564*** & 5.546*** \\
 & (1.457) & (1.579) \\
...
\end{tabular}
\label{tab:regime}
\caption*{\textit{Notes:} The dependent variable is the average matched difference in daily yield changes between hedge fund bonds and their paired controls on each announcement day (bps), as in Appendix \ref{subsec:announcement}. \textit{Surprise} is the change in the 2-year OIS rate during the ECB event window (bps). \textit{Sector Dir.}\ is the position-weighted average of holder directionality across bonds on the announcement day, demeaned (sample mean 0.35). \textit{2022} is an indicator for announcements in 2022. One announcement precedes the first available directionality measurement, leaving 37 of the 38 announcements. Robust standard errors in parentheses. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}


\clearpage
\subsection{Position side, constraint regime, and book directionality}
\label{subsec:side_book}
Table \ref{tab:side_book} splits the constraint-regime regressions of Table \ref{tab:asymmetry} by the side of the hedge fund position and by the directionality of the books holding the bond. Panel A shows that within directional books the amplification is present in all four cells. On the constraining side it is almost the same for long and short positions, as a margin constraint that binds mechanically implies. On the relaxing side it is 0.124 for long positions and 0.379 for short positions, which is the configuration in which the coordinated net-short book of the hiking cycle meets a surprise that confirms its direction. Panel B shows that within hedged books the amplification is close to zero in every cell. The absence of amplification within hedged books therefore holds regardless of the side of the position and of whether the shock moves against it or in its favor. \\
\begin{table}[h!]
\centering
\caption{\textbf{Amplification by Position Side, Constraint Regime, and Book}}
\footnotesize
...
\textbf{Dependent Variable:} & \multicolumn{4}{c}{\textbf{$\Delta$ Bond Yield (bps)}} \\
\cmidrule(lr){2-5}
 & \multicolumn{2}{c}{Net long} & \multicolumn{2}{c}{Net short} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
 & Constraining & Relaxing & Constraining & Relaxing \\
\midrule
\multicolumn{5}{l}{\textit{Panel A: Bonds held within directional books}} \\
\addlinespace
Log HF Intensity $\times$ Shock & 0.185*** & 0.124*** & 0.172*** & 0.379*** \\
 & (0.040) & (0.035) & (0.042) & (0.030) \\
Log HF Intensity & $-$0.020 & $-$0.013 & $-$0.014 & $-$0.022 \\
 & (0.017) & (0.017) & (0.017) & (0.017) \\
Observations & 464,293 & 464,633 & 464,908 & 464,589 \\
R-squared & 0.731 & 0.731 & 0.733 & 0.734 \\
\midrule
\multicolumn{5}{l}{\textit{Panel B: Bonds held within hedged books}} \\
\addlinespace
Log HF Intensity $\times$ Shock & 0.061 & 0.050** & 0.034** & 0.044 \\
 & (0.054) & (0.023) & (0.017) & (0.060) \\
Log HF Intensity & $-$0.017 & $-$0.015 & $-$0.016 & $-$0.017 \\
 & (0.017) & (0.017) & (0.017) & (0.017) \\
Observations & 464,334 & 464,767 & 464,904 & 464,441 \\
R-squared & 0.731 & 0.731 & 0.731 & 0.732 \\
\midrule
Bond FE & Yes & Yes & Yes & Yes \\
Duration $\times$ Date $\times$ Country FE & Yes & Yes & Yes & Yes \\
Bid-Ask Spread and CTD Controls & Yes & Yes & Yes & Yes \\
...
\end{tabular}
\label{tab:side_book}
\caption*{\textit{Notes:} The dependent variable is the daily change in bond yield (bps). Each column re-estimates the intensity regression of Table \ref{tab:asymmetry} on one cell. \textit{Net long} and \textit{Net short} refer to the sign of the hedge fund sectors net position in the bond, and the constraining and relaxing regimes are defined as in Table \ref{tab:asymmetry}. Panel A restricts the hedge fund bond-days on shock days to bonds held within directional books and Panel B to bonds held within hedged books, split at the median of holder directionality as in Table \ref{tab:directionality}. All non-shock days and all bond-days with zero hedge fund intensity are included in every column as the within-bond baseline. The Shock main effect is absorbed by the fixed effects. Standard errors are clustered by business date and bond. *** p$<$0.01, ** p$<$0.05, * p$<$0.10. \\ Sample period: 2021-01-01 -- 2025-11-01}
\end{table}
