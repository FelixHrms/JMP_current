...
\medskip
\noindent\textbf{Prediction 1 (amplification).} \textit{Bonds in which hedge funds hold leveraged positions react more strongly to a price shock than otherwise comparable bonds, and the differential increases with the size of the position relative to the amount outstanding.}
\medskip
...
\medskip
\noindent\textbf{Prediction 4 (hedged books).} \textit{The differential is confined to books with net exposure to the shock and is absent for duration-hedged books.}
\medskip

Section \ref{subsec:amplification} tests Predictions 1 and 2, Section \ref{subsec:asymmetries} tests Prediction 3, and Section \ref{sec:directionality} tests Prediction 4. The predictions concern the sign, symmetry, timing, and incidence of the yield response and the direction of the position response. They do not concern the motive behind the position adjustment, which Section \ref{subsec:asymmetries} discusses in light of the evidence.
