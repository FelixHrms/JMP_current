...
\medskip
\noindent\textbf{Prediction 1 (amplification).} \textit{Bonds in which hedge funds hold leveraged positions react more strongly to a monetary policy surprise than otherwise comparable bonds.}
\medskip

The two sides differ in their nature, however. The contraction is enforced by the requirement to keep meeting margin, while the expansion is voluntary. The contraction is the deleveraging response studied in the literature on funding constraints, in which losses erode capital and force position reductions \citep{brunnermeier2009, geanakoplos2010}. The expansion is its counterpart under the balance sheet management of \citet{adrian2014}, in which freed capacity is redeployed into the existing exposure. Such redeployment is also the optimal response of a constrained arbitrageur whose desired position exceeds its funding capacity, because a favorable surprise enlarges the capacity while the remaining expected return still justifies a larger position than the enlarged balance sheet permits \citep{gromb2002}, and hedge funds are indeed documented to raise leverage when asset values rise and funding costs fall \citep{ang2011}. Appendix \ref{subsec:calibration} works through a numerical example of both sides.

\medskip
\noindent\textbf{Prediction 2 (symmetry).} \textit{The differential is present both when the surprise moves prices against the position and when it moves in its favor, and the underlying position adjustments have opposite signs, a contraction in the first case and an expansion in the second.}
\medskip

The yield reaction to the position adjustment depends on the market's ability to absorb it. The trading pressure equals the proportional adjustment multiplied by the share of the bond that the hedge fund sector holds, and its price impact depends on the depth of the market for that bond.

\medskip
\noindent\textbf{Prediction 3 (position size).} \textit{The differential increases with the size of the position relative to the amount outstanding.}
\medskip

The additional yield move reflects trading pressure rather than a change in fundamentals. It should therefore not persist, and it should revert as the adjustment is completed and other capital absorbs the imbalance.

\medskip
\noindent\textbf{Prediction 4 (reversion).} \textit{The differential is temporary. It appears on the announcement day and reverts within days.}
\medskip
...
\medskip
\noindent\textbf{Prediction 5 (hedged books).} \textit{The differential is confined to books with net exposure to the shock and is absent for duration-hedged books.}
\medskip

Section \ref{subsec:amplification} tests Predictions 1, 3, and 4, Section \ref{subsec:asymmetries} tests Prediction 2, and Section \ref{sec:directionality} tests Prediction 5. The predictions concern the sign, symmetry, timing, and incidence of the yield response and the direction of the position response. They do not concern the motive behind the position adjustment, which Section \ref{subsec:asymmetries} discusses in light of the evidence.
