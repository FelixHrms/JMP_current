...
I start from the selection concern raised in Section \ref{sec:identification} and examine whether the bonds hedge funds hold are more volatile in the first place. I regress the absolute daily yield change on a hedge fund presence dummy and its interaction with the absolute shock:
