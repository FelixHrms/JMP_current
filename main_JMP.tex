...
\medskip
\noindent\textbf{Prediction 1 (amplification).} \textit{Bonds in which hedge funds hold leveraged positions react more strongly to a price shock than otherwise comparable bonds.}
\medskip
...
\medskip
\noindent\textbf{Prediction 2 (symmetry).} \textit{The amplification is present both when the surprise moves prices against the position and when it moves in its favor, with a position contraction in the first case and an expansion in the second.}
\medskip
