...
Identifying this effect requires both detailed position data and a clean source of exogenous price variation. The repo market data provide a transaction-level view of the euro area repo market and allow me to track the daily positioning of hedge funds across individual sovereign bonds. To address the second, I combine this micro data with bond market data and high-frequency monetary policy surprises, which serve as a laboratory for exogenous price variation. By interacting the pre-determined net positions of hedge funds with the shock, I estimate the additional yield sensitivity that arises when hedge funds are trading a given bond. I then use the full cross section of each fund's positions to show that the amplification depends on whether the bond sits within a hedged or directional book.

I document four main results. First, even among comparable bonds, hedge funds add excess volatility on shock days but not on regular days. I use duration-by-country-by-date fixed effects to address the fact that hedge funds select into longer duration and thus inherently more volatile bonds. The excess volatility on shock days therefore reflects their positioning rather than the characteristics of the bonds they trade.
