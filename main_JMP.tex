...
Hedge funds have become increasingly important players in global financial markets, and how this growing footprint affects the sensitivity of asset prices to shocks can be viewed from two perspectives. By correcting mispricings and providing liquidity, hedge funds could push prices toward fundamental value and dampen the reaction to shocks \citep{gromb2002, cao2018}. Their reliance on leverage, however, means that when funding conditions deteriorate, forced liquidations can push prices further from fundamentals rather than closer to them, amplifying the reaction \citep{shleifer1997, brunnermeier2009, geanakoplos2010}. Whether hedge funds increase or decrease price sensitivity in a given situation is ultimately an empirical question, and granular evidence remains scarce. 

In this paper, I use granular regulatory data on euro area repo transactions to show that the leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks. For bonds traded by hedge funds, more than a quarter of the yield reaction to monetary policy surprises reflects positioning rather than the fundamental news itself. This overshooting is temporary and its strength depends not only on the size of the position but also on the directionality of the hedge fund book that holds it.

This question has become even more important as financial intermediation has shifted away from traditional banks since the global financial crisis \citep{pelizzon2025nbfi}. Among non-bank financial intermediaries (NBFIs), offshore hedge funds have attracted particular attention because of their opacity and their strong use of leverage \citep{barth2025cross}. They finance their trading positions with short-term repurchase agreements, which makes their funding highly sensitive to sudden changes in the value of the collateral, a fragility that surfaced in March 2020 when forced deleveraging by hedge funds exacerbated stress in the US Treasury market \citep{barth2025, kruttli2025, aramonte2023}. Yet granular data on their repo positioning has been largely unavailable, and the existing evidence is concentrated in stress episodes and focused on market functioning rather than the cross-sectional pricing of bonds. This leaves open whether leveraged non-bank trading shapes price formation outside of crises, and what kind of positioning drives the effect when it does.

Answering this question requires both detailed position data and a clean source of exogenous price variation. To address the first requirement, I use a dataset that provides a transaction-level view of the euro area repo market and allows me to track the daily positioning of hedge funds across individual sovereign bonds. To address the second, I combine this micro data with bond market data and high-frequency monetary policy surprises, which serve as a laboratory for exogenous price variation. By interacting the pre-determined net positions of hedge funds with the shock, I estimate the additional yield sensitivity that arises when hedge funds are trading a given bond. I then use the full cross section of each fund's positions to show that the amplification depends on whether the bond sits within a hedged or directional book.
...
A second challenge is that any amplification could reflect the behavior of the dealers that intermediate hedge fund trades. If dealers respond to shocks in ways that systematically differ across the bonds where they maintain active hedge fund relationships, the results could capture dealer rather than hedge fund behavior. To provide evidence against this explanation, I decompose the bond-date panel into dealer-bond-date observations, introduce increasingly demanding dealer fixed effect structures, and use credit default swaps to estimate whether the effect scales with dealer stress. The analysis confirms that the effect operates through hedge fund positioning, rather than the behavior of dealer banks.

For policymakers assessing the risks stemming from hedge fund activity in sovereign bond markets, my results imply that neither the size of hedge fund positions nor their presence is sufficient to evaluate the risk. Risk monitoring should not be confined to stress episodes, since the amplification also operates when shocks favor existing positions, and it should treat the directionality of the book as a key risk metric, since the same position amplifies a shock within a directional book and is close to neutral within a hedged book.
