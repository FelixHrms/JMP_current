...
This section lays out the interpretation that organizes the empirical analysis. It is not a model. Its purpose is to motivate the sample splits used below and to fix the language in which the results are discussed, and the contribution of the paper lies in the measurement rather than in the framework. One distinction matters throughout. The response of a leveraged fund to a shock that moves prices against its position follows from margin mechanics. The response to a shock that moves prices in its favor is a hypothesis, and the data can check whether the position adjusts in the predicted direction but not why it does. Appendix \ref{subsec:calibration} works through a calibrated example of both sides with sample moments.
