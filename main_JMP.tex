...
This paper addresses this gap using granular regulatory data on euro area repo transactions. I show that the leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks. For bonds traded by hedge funds, more than a quarter of the yield reaction to shocks reflects positioning rather than the fundamental news itself. This overshooting is temporary, and its strength depends not only on the size of the position but also on the directionality of the hedge fund book that holds it.
