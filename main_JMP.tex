...
Table \ref{tab:pair_balance} describes the matched sample underlying Column (5) of Table \ref{tab:baseline}. Each pair consists of a bond with active hedge fund repo positions on a given day and the non-hedge fund bond from the same duration-country-date cell that is closest in terms of bid-ask spread. The table reports the average characteristics of both sides of the pairs together with the mean and median within-pair differences. In the median pair, the two bonds differ by [xx] years of duration and [xx] euro of bid-ask spread. Balance on the bid-ask spread is by construction, since it is the matching variable, and duration differences are bounded by the two-year cell width; balance on the remaining characteristics is not targeted by the matching procedure and is therefore informative about the quality of the comparison. \\
...
\midrule
Duration (years) & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx \\
Residual Maturity (years) & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx \\
Amount Issued (\euro\ bn) & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx \\
Bid-Ask Spread (\euro) & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx \\
Yield (\%) & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx & xx.xx \\
CTD Flag (share) & xx.xx & xx.xx & xx.xx & -- & xx.xx & xx.xx \\
\midrule
Pairs & \multicolumn{6}{c}{xx} \\
Distinct HF bonds & \multicolumn{6}{c}{xx} \\
Distinct non-HF bonds & \multicolumn{6}{c}{xx} \\
Distinct dates & \multicolumn{6}{c}{xx} \\
CTD mismatch rate & \multicolumn{6}{c}{xx.xx} \\
\bottomrule
\end{tabular}
