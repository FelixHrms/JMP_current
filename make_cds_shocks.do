********************************************************************************
* BUILD: CDS SHOCKS
* Inputs: Data\cds_ecb.csv, Data\vix.csv, Data\it_position.csv, Data\altavilla.xlsx
* Output: Data\cds_shock.csv   (run AFTER build_cds_panel 1st pass, BEFORE its 2nd pass)
********************************************************************************

*--- Layer 1: Residualize ΔCDS into its unanticipated component ---

* CDS
import delimited "C:\Users\hermesf\Projects\JobMarket\Data\cds_ecb.csv", clear
...
preserve
import delimited "C:\Users\hermesf\Projects\JobMarket\Data\it_position.csv", clear
...
export delimited using "C:\Users\hermesf\Projects\JobMarket\Data\cds_shock.csv", replace
count