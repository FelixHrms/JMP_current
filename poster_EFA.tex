...
\begin{minipage}[c]{300mm}
  ...
  \vspace{2mm}
  {\fTiny\color{midgrey} $\mathrm{Dir}_{f}$ is zero when long and short legs of a fund offset in duration terms and one when the book is one-sided, with $D_{i}$ the duration and $q_{f,i}$ the net position in bond $i$. $\mathrm{HolderDir}_{i}$ is the position-weighted average per bond.\par}
  \vspace{13.5mm}
  \fTab
  \begin{tabular}{l c}
    \toprule
