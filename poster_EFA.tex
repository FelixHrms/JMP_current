...
\newcommand{\fTab}{\fontsize{22.5}{31}\selectfont}
...
\newcommand{\FigNote}[1]{\vspace{1.5mm}{\fTiny\color{midgrey}#1\par}}
...
\begin{tcolorbox}[colback=navy,colframe=navy,sharp corners,boxrule=0pt,
    width=710mm,left=50mm,right=50mm,top=26mm,bottom=18mm]
  \color{white}
  \centering
...
\begin{tcolorbox}[colback=paleg,colframe=grn,boxrule=1.4pt,arc=3mm,left=7mm,right=7mm,top=4.5mm,bottom=4.5mm]
...
\end{minipage}\hfill
\begin{minipage}[t]{302mm}
\begin{tcolorbox}[colback=paler,colframe=rust,boxrule=1.4pt,arc=3mm,left=7mm,right=7mm,top=4.5mm,bottom=4.5mm]
...
\begin{center}
\begin{tikzpicture}[box/.style={draw=navy,line width=1.3pt,rounded corners=3mm,align=center,inner xsep=7mm,inner ysep=5mm}]
...
\begin{minipage}[c]{266mm}
  \includegraphics[width=266mm]{Figures/intensity_volatility_bars.png}
...
\begin{minipage}[c]{300mm}
  \centering
  \includegraphics[width=290mm]{Figures/IR_baseline_decomposition_overshoot.png}
...
\end{minipage}\hfill
\begin{minipage}[c]{298mm}
  \centering
  \includegraphics[width=296mm]{Figures/IR_on_momentum.png}
...
\begin{minipage}[c]{300mm}
  \centering
  \includegraphics[width=292mm]{Figures/motivation_chart.png}
...
\vspace{8mm}
{\fSmall\color{midgrey}\textbf{Robust to:} dealer $\times$ date fixed effects (0.248--0.294$^{***}$) $\cdot$ GARCH-standardized yields $\cdot$ sovereign credit (CDS) shocks (0.225$^{***}$) $\cdot$ French and Spanish bonds $\cdot$ placebo with shifted shock dates ($-$0.030, n.s.) $\cdot$ randomization inference ($p<0.001$).\par}
