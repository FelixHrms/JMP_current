...
\newcommand{\SectionTag}[2]{%
  {\tcbox[enhanced,nobeforeafter,tcbox raise base,arc=2.5mm,colback=navy,colframe=navy,boxrule=0pt,
    left=4mm,right=4mm,top=1.8mm,bottom=1.8mm]{\fHead\bfseries\color{white}#1}%
   \hspace{6mm}{\fSect\bfseries\color{navy}#2}\par}
  \vspace{2.5mm}{\color{navy}\rule{\textwidth}{1.5pt}}\par
  \vspace{6mm}}
...
\begin{tikzpicture}[box/.style={draw=navy,line width=1.3pt,rounded corners=3mm,align=center,
    inner xsep=9mm,inner ysep=7mm,text=ink,font=\fHead}]
  \node[box,draw=rust,fill=paler] (con)
    {{\fontsize{34}{44}\selectfont\bfseries\color{rust}Constraining}\\[3mm]
     price moves \textit{against} the position\\[1mm]
     the capital buffer erodes\\[1mm]
     the fund \textbf{reduces} exposure};
  \node[box,fill=pale,text=navy,font=\fontsize{34}{44}\selectfont\bfseries,right=14mm of con] (top)
    {Shock meets a\\[2mm] predetermined\\[2mm] leveraged position};
  \node[box,draw=grn,fill=paleg,right=14mm of top] (rel)
    {{\fontsize{34}{44}\selectfont\bfseries\color{grn}Relaxing}\\[3mm]
     price moves \textit{in favor}\\[1mm]
     the constraint loosens\\[1mm]
     the fund \textbf{expands} exposure};
  \draw[-{Latex[length=6mm]},line width=1.8pt,navy] (top.west) -- (con.east);
  \draw[-{Latex[length=6mm]},line width=1.8pt,navy] (top.east) -- (rel.west);
\end{tikzpicture}
\end{center}
...
% ============================ FINDING 1 ============================
\begin{Panel}
\SectionTag{Finding 1}{Hedge funds increase the volatility of bond yields on shock days}
...
% ============================ FINDING 2 ============================
\begin{Panel}
\SectionTag{Finding 2}{Hedge fund trading raises the sensitivity of yields to shocks}
...
% ============================ FINDING 3 ============================
\begin{Panel}
\SectionTag{Finding 3}{The amplification holds whether shocks help or hurt the position}
...
% ============================ FINDING 4 ============================
\begin{Panel}
\SectionTag{Finding 4}{The directionality of the book governs the strength}
...
% ========================= CONCLUSION =========================
\begin{Panel}
\SectionTag{Conclusion}{What this means for risk monitoring}
