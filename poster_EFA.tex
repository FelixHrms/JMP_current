...
\begin{minipage}[c]{300mm}
  ...
  \vspace{2mm}
  {\fTiny\color{midgrey}Zero when long and short legs offset in duration terms and one when the book is one-sided, with $D_{i}$ the duration and $q_{f,i}$ the net position in bond $i$. \par}
  \vspace{4.5mm}
  \fTab
  \begin{tabular}{l c}
    \toprule
