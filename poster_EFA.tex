...
\begin{tcolorbox}[colback=navy,colframe=navy,sharp corners,boxrule=0pt,
  ...
  \vspace{7mm}
  \parbox{435mm}{\centering\fontsize{30}{40}\selectfont\color{pale}\itshape
    The leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks, leading to temporary overshooting.\par}\par
  \vspace{7mm}
