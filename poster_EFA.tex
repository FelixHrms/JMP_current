...
% ========================= MAIN RESULT =========================
\par\vspace{6mm plus 3mm}\noindent\hspace*{-12mm}
\begin{tcolorbox}[enhanced,colback=pale,colframe=navy,boxrule=1.8pt,arc=5mm,
    width=644mm,left=16mm,right=16mm,top=6mm,bottom=6mm,nobeforeafter]
  \centering{\fHead\bfseries\color{navy}The leveraged positioning of hedge funds amplifies the response of sovereign bond yields to shocks, leading to temporary overshooting.\par}
\end{tcolorbox}\par
