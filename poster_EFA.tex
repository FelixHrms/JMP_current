...
\begin{tcolorbox}[colback=pale,colframe=pale,arc=3mm,left=9mm,right=9mm,top=5.5mm,bottom=5.5mm]
  \centering{\fHead\bfseries\color{navy}Yes. Positioning accounts for more than a quarter of the shock-day yield move, the overshooting is temporary, and the directionality of the book governs its strength.\par}
\end{tcolorbox}
\end{Panel}
