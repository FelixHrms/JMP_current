...
\begin{minipage}[c]{310mm}
  ...
  \begin{tabular}{l c c}
    ...
    \bottomrule
  \end{tabular}
  \FigNote{\centering Dependent variable is the absolute daily yield change in basis points. Column (2) identifies the effect within cells of bonds of similar duration from the same issuer on the same day. Standard errors clustered by date and bond. $^{***}$ $p<0.01$.\par}
\end{minipage}
...
\begin{minipage}[c]{300mm}
  ...
  \begin{tabular}{l c c c}
    ...
    \bottomrule
  \end{tabular}
  \FigNote{\centering Dependent variable is the daily yield change in basis points. HF intensity is the log of one plus the five-day net position scaled by amount outstanding. Column (2) pairs each hedge fund bond with the twin closest in liquidity within its duration, country and date cell. Standard errors clustered by date and bond, in column (2) by cell and twin. $^{***}$ $p<0.01$.\par}
  \par\vspace{3.5mm}
  {\fontsize{40}{44}\selectfont\bfseries\color{rust}$>$\,25\%\par}\vspace{1.5mm}
