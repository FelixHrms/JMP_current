...
% Build (print-ready: text outlined, CMYK, no crop marks):
%   lualatex poster_EFA.tex
...
\setlist[itemize]{label={\textcolor{navy}{\rule[0.18em]{0.5em}{0.5em}}},leftmargin=1.4em,itemsep=0.3\baselineskip,parsep=0pt,topsep=0.25\baselineskip}
...
\begin{minipage}[c]{248mm}
  \includegraphics[width=248mm]{Figures/intensity_volatility_bars.png}
...
\begin{minipage}[c]{300mm}
  \centering
  \includegraphics[width=288mm]{Figures/shock_reaction_scatterplot_2x.png}
...
\begin{minipage}[c]{300mm}
  \centering
  \includegraphics[width=288mm]{Figures/IR_baseline.png}
...
\begin{minipage}[c]{270mm}
  \centering
  {\fStat\bfseries\color{rust}$>$\,25\%\par}\vspace{2.5mm}
...
\begin{minipage}[c]{298mm}
  \centering
  \includegraphics[width=296mm]{Figures/motivation_chart_2x.png}
