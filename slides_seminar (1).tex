...
\eit
\svs
\lead{Taking the question to the data}
\ben\itemsep3pt
  \item Leveraged positioning \\
        {\footnotesize Constructed from regulatory repo data that track daily hedge fund positions in individual sovereign bonds}
  \item Shocks \\
        {\footnotesize Measured with high frequency monetary policy surprises that move yields exogenously {\scriptsize\color{softgrey}\citep{altavilla2019}}}
\een
\svs
\lead{Strategy}
\bit
...
\svs
\begin{center}
\measureplot{0.075}{0.99}{\includegraphics[width=0.72\textwidth,height=0.56\textheight,keepaspectratio]{Figures/intensity_volatility_bars.png}}
\end{center}
...
\takeaway{Excess volatility is limited to shock days}
\end{frame}
...
\takeaway{Not price discovery, yields overshoot and revert within days, a temporary dislocation}
\end{frame}

% --- Walkthrough 3: symmetry ---
\begin{frame}{Finding 3: The effect is symmetric}
\hypertarget{finding3}{}
\svs
\begin{center}
\measureplot{0.078}{0.973}{\includegraphics[width=0.72\textwidth,height=0.6\textheight,keepaspectratio]{Figures/IR_on_momentum.png}}
\end{center}
...
\begin{frame}{Finding 4: It is concentrated in directional books}
\svs
\begin{center}
\measureplot{0.062}{0.991}{\includegraphics[width=0.72\textwidth,height=0.6\textheight,keepaspectratio]{Figures/motivation_chart.png}}
\end{center}
...
\resultdivider{1}{Hedge funds increase the volatility of bond yields on shock days}
...
\end{column}
\end{columns}
\takeaway{For that reason the preferred design uses duration $\times$ country $\times$ date fixed effects}
\end{frame}

\resultdivider{2}{Hedge fund trading raises the sensitivity of yields to shocks}
...
% Two-step build: panel (a) alone first; a click adds panel (b), the title suffix,
% the takeaway, and the annex button.
