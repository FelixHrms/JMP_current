...
% --- Walkthrough 3: symmetry (aggregate book change by regime, position_symmetry_bars.do)
% Verbal cues: whole sector book, long side and short side, EUR bn. The shock
% labels the sides: constrained book shrinks, relaxed book grows. Both moves
% trade in the direction of the shock, previewing the LP evidence in Result 3.
\begin{frame}{The effect is symmetric, whether the shock helps or hurts the position}
\svs
\begin{center}
\includegraphics[width=0.72\textwidth,height=0.6\textheight,keepaspectratio]{Figures/position_symmetry_bars.png}
\end{center}
\takeaway{Funds cut the book the shock hurts and add to the one it helps, in both cases trading with the shock}
\end{frame}
...
\svs
\begin{center}
\includegraphics[width=0.72\textwidth,height=0.6\textheight,keepaspectratio]{Figures/motivation_chart.png}
\end{center}
...
\begin{center}
\measureplot{0.078}{0.973}{\includegraphics[height=0.56\textheight,keepaspectratio]{Figures/IR_on_momentum.png}}
\end{center}
