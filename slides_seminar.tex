...
\svs
\begin{center}
\figph{binned scatter of bond volatility against hedge fund holdings, shock days versus normal days. Normal-day line flat, shock-day line rising in holdings}
\end{center}
...
\begin{center}
\measureplot{0.062}{0.991}{\includegraphics[height=0.72\textheight,keepaspectratio]{Figures/motivation_chart.png}}
\end{center}
...
\begin{center}
\measureplot{0.067}{0.972}{\includegraphics[width=0.76\textwidth,height=0.66\textheight,keepaspectratio]{Figures/shock_reaction_scatterplot.png}}
\end{center}
